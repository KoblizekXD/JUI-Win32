...
final class constants$720 {
    ...
    static final MethodHandle CryptCreateHash$MH = RuntimeHelper.downcallHandle(
        "CryptCreateHash",
        constants$720.CryptCreateHash$FUNC
    );
    ...
    static final MethodHandle CryptHashData$MH = RuntimeHelper.downcallHandle(
        "CryptHashData",
        constants$720.CryptHashData$FUNC
    );
    ...
    static final MethodHandle CryptHashSessionKey$MH = RuntimeHelper.downcallHandle(
        "CryptHashSessionKey",
        constants$720.CryptHashSessionKey$FUNC
    );
    ...
    static final MethodHandle CryptDestroyHash$MH = RuntimeHelper.downcallHandle(
        "CryptDestroyHash",
        constants$720.CryptDestroyHash$FUNC
    );
    ...
    static final MethodHandle CryptSignHashA$MH = RuntimeHelper.downcallHandle(
        "CryptSignHashA",
        constants$720.CryptSignHashA$FUNC
    );
    ...
    static final MethodHandle CryptSignHashW$MH = RuntimeHelper.downcallHandle(
        "CryptSignHashW",
        constants$720.CryptSignHashW$FUNC
    );
}
