...
public class HGESTUREINFO__ {
    ...
    public static MemoryLayout $LAYOUT() {
        return HGESTUREINFO__.$struct$LAYOUT;
    }
    ...
    public static VarHandle unused$VH() {
        return HGESTUREINFO__.unused$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int unused$get(MemorySegment seg) {
        return (int)HGESTUREINFO__.unused$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void unused$set(MemorySegment seg, int x) {
        HGESTUREINFO__.unused$VH.set(seg, x);
    }
    public static int unused$get(MemorySegment seg, long index) {
        return (int)HGESTUREINFO__.unused$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void unused$set(MemorySegment seg, long index, int x) {
        HGESTUREINFO__.unused$VH.set(seg.asSlice(index*sizeof()), x);
    }
