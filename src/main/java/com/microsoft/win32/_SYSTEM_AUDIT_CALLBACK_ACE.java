...
public class _SYSTEM_AUDIT_CALLBACK_ACE {
    ...
    public static MemoryLayout $LAYOUT() {
        return _SYSTEM_AUDIT_CALLBACK_ACE.$struct$LAYOUT;
    }
    ...
    public static VarHandle Mask$VH() {
        return _SYSTEM_AUDIT_CALLBACK_ACE.Mask$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int Mask$get(MemorySegment seg) {
        return (int)_SYSTEM_AUDIT_CALLBACK_ACE.Mask$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Mask$set(MemorySegment seg, int x) {
        _SYSTEM_AUDIT_CALLBACK_ACE.Mask$VH.set(seg, x);
    }
    public static int Mask$get(MemorySegment seg, long index) {
        return (int)_SYSTEM_AUDIT_CALLBACK_ACE.Mask$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void Mask$set(MemorySegment seg, long index, int x) {
        _SYSTEM_AUDIT_CALLBACK_ACE.Mask$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle SidStart$VH() {
        return _SYSTEM_AUDIT_CALLBACK_ACE.SidStart$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int SidStart$get(MemorySegment seg) {
        return (int)_SYSTEM_AUDIT_CALLBACK_ACE.SidStart$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void SidStart$set(MemorySegment seg, int x) {
        _SYSTEM_AUDIT_CALLBACK_ACE.SidStart$VH.set(seg, x);
    }
    public static int SidStart$get(MemorySegment seg, long index) {
        return (int)_SYSTEM_AUDIT_CALLBACK_ACE.SidStart$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void SidStart$set(MemorySegment seg, long index, int x) {
        _SYSTEM_AUDIT_CALLBACK_ACE.SidStart$VH.set(seg.asSlice(index*sizeof()), x);
    }
