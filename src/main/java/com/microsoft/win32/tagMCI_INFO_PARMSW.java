...
public class tagMCI_INFO_PARMSW {
    ...
    public static MemorySegment lpstrReturn$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagMCI_INFO_PARMSW.lpstrReturn$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpstrReturn$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagMCI_INFO_PARMSW.lpstrReturn$VH.get(seg.asSlice(index*sizeof()));
    }
