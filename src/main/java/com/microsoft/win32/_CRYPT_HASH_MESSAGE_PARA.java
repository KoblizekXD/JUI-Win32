...
public class _CRYPT_HASH_MESSAGE_PARA {
    ...
    public static MemorySegment pvHashAuxInfo$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CRYPT_HASH_MESSAGE_PARA.pvHashAuxInfo$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pvHashAuxInfo$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CRYPT_HASH_MESSAGE_PARA.pvHashAuxInfo$VH.get(seg.asSlice(index*sizeof()));
    }
