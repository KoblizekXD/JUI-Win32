...
public class tagDIBSECTION {
    ...
    public static MemorySegment dshSection$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagDIBSECTION.dshSection$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment dshSection$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagDIBSECTION.dshSection$VH.get(seg.asSlice(index*sizeof()));
    }
