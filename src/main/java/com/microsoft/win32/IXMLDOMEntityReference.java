...
public class IXMLDOMEntityReference {
    ...
    public static MemoryLayout $LAYOUT() {
        return IXMLDOMEntityReference.$struct$LAYOUT;
    }
    ...
    public static VarHandle lpVtbl$VH() {
        return IXMLDOMEntityReference.lpVtbl$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)IXMLDOMEntityReference.lpVtbl$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpVtbl$set(MemorySegment seg, MemorySegment x) {
        IXMLDOMEntityReference.lpVtbl$VH.set(seg, x);
    }
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)IXMLDOMEntityReference.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpVtbl$set(MemorySegment seg, long index, MemorySegment x) {
        IXMLDOMEntityReference.lpVtbl$VH.set(seg.asSlice(index*sizeof()), x);
    }
