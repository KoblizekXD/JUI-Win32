...
public class _SERVICE_REQUIRED_PRIVILEGES_INFOW {
    ...
    public static MemorySegment pmszRequiredPrivileges$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_SERVICE_REQUIRED_PRIVILEGES_INFOW.pmszRequiredPrivileges$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pmszRequiredPrivileges$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_SERVICE_REQUIRED_PRIVILEGES_INFOW.pmszRequiredPrivileges$VH.get(seg.asSlice(index*sizeof()));
    }
