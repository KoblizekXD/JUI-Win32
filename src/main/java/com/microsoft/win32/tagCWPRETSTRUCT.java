...
public class tagCWPRETSTRUCT {
    ...
    public static MemorySegment hwnd$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagCWPRETSTRUCT.hwnd$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment hwnd$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagCWPRETSTRUCT.hwnd$VH.get(seg.asSlice(index*sizeof()));
    }
