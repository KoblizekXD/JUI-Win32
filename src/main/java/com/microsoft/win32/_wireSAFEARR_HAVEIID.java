...
public class _wireSAFEARR_HAVEIID {
    ...
    public static MemorySegment apUnknown$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_wireSAFEARR_HAVEIID.apUnknown$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment apUnknown$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_wireSAFEARR_HAVEIID.apUnknown$VH.get(seg.asSlice(index*sizeof()));
    }
