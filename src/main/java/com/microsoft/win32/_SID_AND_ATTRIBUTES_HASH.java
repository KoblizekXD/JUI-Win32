...
public class _SID_AND_ATTRIBUTES_HASH {
    ...
    public static MemorySegment SidAttr$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_SID_AND_ATTRIBUTES_HASH.SidAttr$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment SidAttr$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_SID_AND_ATTRIBUTES_HASH.SidAttr$VH.get(seg.asSlice(index*sizeof()));
    }
