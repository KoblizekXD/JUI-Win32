...
public class _CMC_TAGGED_OTHER_MSG {
    ...
    public static MemorySegment pszObjId$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CMC_TAGGED_OTHER_MSG.pszObjId$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pszObjId$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CMC_TAGGED_OTHER_MSG.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
