...
public class _CRYPT_DECODE_PARA {
    ...
    public static MemoryLayout $LAYOUT() {
        return _CRYPT_DECODE_PARA.$struct$LAYOUT;
    }
    static final VarHandle cbSize$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("cbSize"));
    public static VarHandle cbSize$VH() {
        return _CRYPT_DECODE_PARA.cbSize$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int cbSize$get(MemorySegment seg) {
        return (int)_CRYPT_DECODE_PARA.cbSize$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cbSize$set(MemorySegment seg, int x) {
        _CRYPT_DECODE_PARA.cbSize$VH.set(seg, x);
    }
    public static int cbSize$get(MemorySegment seg, long index) {
        return (int)_CRYPT_DECODE_PARA.cbSize$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void cbSize$set(MemorySegment seg, long index, int x) {
        _CRYPT_DECODE_PARA.cbSize$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle pfnAlloc$VH() {
        return _CRYPT_DECODE_PARA.pfnAlloc$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pfnAlloc$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CRYPT_DECODE_PARA.pfnAlloc$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pfnAlloc$set(MemorySegment seg, MemorySegment x) {
        _CRYPT_DECODE_PARA.pfnAlloc$VH.set(seg, x);
    }
    public static MemorySegment pfnAlloc$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CRYPT_DECODE_PARA.pfnAlloc$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pfnAlloc$set(MemorySegment seg, long index, MemorySegment x) {
        _CRYPT_DECODE_PARA.pfnAlloc$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle pfnFree$VH() {
        return _CRYPT_DECODE_PARA.pfnFree$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pfnFree$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CRYPT_DECODE_PARA.pfnFree$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pfnFree$set(MemorySegment seg, MemorySegment x) {
        _CRYPT_DECODE_PARA.pfnFree$VH.set(seg, x);
    }
    public static MemorySegment pfnFree$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CRYPT_DECODE_PARA.pfnFree$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pfnFree$set(MemorySegment seg, long index, MemorySegment x) {
        _CRYPT_DECODE_PARA.pfnFree$VH.set(seg.asSlice(index*sizeof()), x);
    }
