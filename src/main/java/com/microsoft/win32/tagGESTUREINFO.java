...
public class tagGESTUREINFO {
    ...
    public static MemorySegment hwndTarget$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagGESTUREINFO.hwndTarget$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment hwndTarget$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagGESTUREINFO.hwndTarget$VH.get(seg.asSlice(index*sizeof()));
    }
