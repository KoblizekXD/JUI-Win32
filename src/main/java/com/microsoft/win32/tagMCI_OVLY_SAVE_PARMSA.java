...
public class tagMCI_OVLY_SAVE_PARMSA {
    ...
    public static MemorySegment lpfilename$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagMCI_OVLY_SAVE_PARMSA.lpfilename$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpfilename$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagMCI_OVLY_SAVE_PARMSA.lpfilename$VH.get(seg.asSlice(index*sizeof()));
    }
