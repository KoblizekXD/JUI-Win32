...
public class IComThreadingInfo {
    ...
    public static MemoryLayout $LAYOUT() {
        return IComThreadingInfo.$struct$LAYOUT;
    }
    ...
    public static VarHandle lpVtbl$VH() {
        return IComThreadingInfo.lpVtbl$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)IComThreadingInfo.lpVtbl$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpVtbl$set(MemorySegment seg, MemorySegment x) {
        IComThreadingInfo.lpVtbl$VH.set(seg, x);
    }
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)IComThreadingInfo.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpVtbl$set(MemorySegment seg, long index, MemorySegment x) {
        IComThreadingInfo.lpVtbl$VH.set(seg.asSlice(index*sizeof()), x);
    }
