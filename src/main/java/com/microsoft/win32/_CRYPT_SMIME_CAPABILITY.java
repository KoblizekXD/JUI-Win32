...
public class _CRYPT_SMIME_CAPABILITY {
    ...
    public static MemoryLayout $LAYOUT() {
        return _CRYPT_SMIME_CAPABILITY.$struct$LAYOUT;
    }
    ...
    public static VarHandle pszObjId$VH() {
        return _CRYPT_SMIME_CAPABILITY.pszObjId$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pszObjId$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CRYPT_SMIME_CAPABILITY.pszObjId$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pszObjId$set(MemorySegment seg, MemorySegment x) {
        _CRYPT_SMIME_CAPABILITY.pszObjId$VH.set(seg, x);
    }
    public static MemorySegment pszObjId$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CRYPT_SMIME_CAPABILITY.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pszObjId$set(MemorySegment seg, long index, MemorySegment x) {
        _CRYPT_SMIME_CAPABILITY.pszObjId$VH.set(seg.asSlice(index*sizeof()), x);
    }
