...
public class IGetBindHandle {
    ...
    public static MemoryLayout $LAYOUT() {
        return IGetBindHandle.$struct$LAYOUT;
    }
    ...
    public static VarHandle lpVtbl$VH() {
        return IGetBindHandle.lpVtbl$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)IGetBindHandle.lpVtbl$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpVtbl$set(MemorySegment seg, MemorySegment x) {
        IGetBindHandle.lpVtbl$VH.set(seg, x);
    }
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)IGetBindHandle.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpVtbl$set(MemorySegment seg, long index, MemorySegment x) {
        IGetBindHandle.lpVtbl$VH.set(seg.asSlice(index*sizeof()), x);
    }
