...
public class _STORAGE_TIER_REGION {
    ...
    public static MemoryLayout $LAYOUT() {
        return _STORAGE_TIER_REGION.$struct$LAYOUT;
    }
    ...
    public static VarHandle Offset$VH() {
        return _STORAGE_TIER_REGION.Offset$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long Offset$get(MemorySegment seg) {
        return (long)_STORAGE_TIER_REGION.Offset$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Offset$set(MemorySegment seg, long x) {
        _STORAGE_TIER_REGION.Offset$VH.set(seg, x);
    }
    public static long Offset$get(MemorySegment seg, long index) {
        return (long)_STORAGE_TIER_REGION.Offset$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void Offset$set(MemorySegment seg, long index, long x) {
        _STORAGE_TIER_REGION.Offset$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle Length$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("Length"));
    public static VarHandle Length$VH() {
        return _STORAGE_TIER_REGION.Length$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long Length$get(MemorySegment seg) {
        return (long)_STORAGE_TIER_REGION.Length$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Length$set(MemorySegment seg, long x) {
        _STORAGE_TIER_REGION.Length$VH.set(seg, x);
    }
    public static long Length$get(MemorySegment seg, long index) {
        return (long)_STORAGE_TIER_REGION.Length$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void Length$set(MemorySegment seg, long index, long x) {
        _STORAGE_TIER_REGION.Length$VH.set(seg.asSlice(index*sizeof()), x);
    }
