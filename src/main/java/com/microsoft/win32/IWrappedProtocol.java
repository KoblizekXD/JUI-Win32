...
public class IWrappedProtocol {
    ...
    public static MemoryLayout $LAYOUT() {
        return IWrappedProtocol.$struct$LAYOUT;
    }
    ...
    public static VarHandle lpVtbl$VH() {
        return IWrappedProtocol.lpVtbl$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)IWrappedProtocol.lpVtbl$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpVtbl$set(MemorySegment seg, MemorySegment x) {
        IWrappedProtocol.lpVtbl$VH.set(seg, x);
    }
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)IWrappedProtocol.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpVtbl$set(MemorySegment seg, long index, MemorySegment x) {
        IWrappedProtocol.lpVtbl$VH.set(seg.asSlice(index*sizeof()), x);
    }
