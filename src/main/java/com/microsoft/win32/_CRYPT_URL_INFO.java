...
public class _CRYPT_URL_INFO {
    ...
    public static MemorySegment rgcGroupEntry$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CRYPT_URL_INFO.rgcGroupEntry$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment rgcGroupEntry$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CRYPT_URL_INFO.rgcGroupEntry$VH.get(seg.asSlice(index*sizeof()));
    }
