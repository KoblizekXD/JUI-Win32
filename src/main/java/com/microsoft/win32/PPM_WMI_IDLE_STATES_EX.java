...
public class PPM_WMI_IDLE_STATES_EX {
    ...
    public static MemorySegment TargetProcessors$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)PPM_WMI_IDLE_STATES_EX.TargetProcessors$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment TargetProcessors$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)PPM_WMI_IDLE_STATES_EX.TargetProcessors$VH.get(seg.asSlice(index*sizeof()));
    }
