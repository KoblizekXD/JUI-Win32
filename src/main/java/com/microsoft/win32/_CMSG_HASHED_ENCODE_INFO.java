...
public class _CMSG_HASHED_ENCODE_INFO {
    ...
    public static MemorySegment pvHashAuxInfo$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CMSG_HASHED_ENCODE_INFO.pvHashAuxInfo$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pvHashAuxInfo$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CMSG_HASHED_ENCODE_INFO.pvHashAuxInfo$VH.get(seg.asSlice(index*sizeof()));
    }
