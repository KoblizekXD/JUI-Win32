...
public class _DISK_HISTOGRAM {
    ...
    public static MemorySegment Histogram$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_DISK_HISTOGRAM.Histogram$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment Histogram$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_DISK_HISTOGRAM.Histogram$VH.get(seg.asSlice(index*sizeof()));
    }
