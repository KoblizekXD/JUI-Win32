...
public class _PROPSHEETPAGEW_V1 {
    ...
    public static MemoryLayout $LAYOUT() {
        return _PROPSHEETPAGEW_V1.$struct$LAYOUT;
    }
    ...
    public static VarHandle dwSize$VH() {
        return _PROPSHEETPAGEW_V1.dwSize$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwSize$get(MemorySegment seg) {
        return (int)_PROPSHEETPAGEW_V1.dwSize$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwSize$set(MemorySegment seg, int x) {
        _PROPSHEETPAGEW_V1.dwSize$VH.set(seg, x);
    }
    public static int dwSize$get(MemorySegment seg, long index) {
        return (int)_PROPSHEETPAGEW_V1.dwSize$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwSize$set(MemorySegment seg, long index, int x) {
        _PROPSHEETPAGEW_V1.dwSize$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle dwFlags$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("dwFlags"));
    public static VarHandle dwFlags$VH() {
        return _PROPSHEETPAGEW_V1.dwFlags$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwFlags$get(MemorySegment seg) {
        return (int)_PROPSHEETPAGEW_V1.dwFlags$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwFlags$set(MemorySegment seg, int x) {
        _PROPSHEETPAGEW_V1.dwFlags$VH.set(seg, x);
    }
    public static int dwFlags$get(MemorySegment seg, long index) {
        return (int)_PROPSHEETPAGEW_V1.dwFlags$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwFlags$set(MemorySegment seg, long index, int x) {
        _PROPSHEETPAGEW_V1.dwFlags$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle hInstance$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("hInstance"));
    public static VarHandle hInstance$VH() {
        return _PROPSHEETPAGEW_V1.hInstance$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment hInstance$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_PROPSHEETPAGEW_V1.hInstance$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void hInstance$set(MemorySegment seg, MemorySegment x) {
        _PROPSHEETPAGEW_V1.hInstance$VH.set(seg, x);
    }
    public static MemorySegment hInstance$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_PROPSHEETPAGEW_V1.hInstance$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void hInstance$set(MemorySegment seg, long index, MemorySegment x) {
        _PROPSHEETPAGEW_V1.hInstance$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle pszTemplate$VH() {
        return _PROPSHEETPAGEW_V1.pszTemplate$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pszTemplate$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_PROPSHEETPAGEW_V1.pszTemplate$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pszTemplate$set(MemorySegment seg, MemorySegment x) {
        _PROPSHEETPAGEW_V1.pszTemplate$VH.set(seg, x);
    }
    public static MemorySegment pszTemplate$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_PROPSHEETPAGEW_V1.pszTemplate$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pszTemplate$set(MemorySegment seg, long index, MemorySegment x) {
        _PROPSHEETPAGEW_V1.pszTemplate$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle pResource$VH() {
        return _PROPSHEETPAGEW_V1.pResource$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pResource$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_PROPSHEETPAGEW_V1.pResource$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pResource$set(MemorySegment seg, MemorySegment x) {
        _PROPSHEETPAGEW_V1.pResource$VH.set(seg, x);
    }
    public static MemorySegment pResource$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_PROPSHEETPAGEW_V1.pResource$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pResource$set(MemorySegment seg, long index, MemorySegment x) {
        _PROPSHEETPAGEW_V1.pResource$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle hIcon$VH() {
        return _PROPSHEETPAGEW_V1.hIcon$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment hIcon$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_PROPSHEETPAGEW_V1.hIcon$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void hIcon$set(MemorySegment seg, MemorySegment x) {
        _PROPSHEETPAGEW_V1.hIcon$VH.set(seg, x);
    }
    public static MemorySegment hIcon$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_PROPSHEETPAGEW_V1.hIcon$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void hIcon$set(MemorySegment seg, long index, MemorySegment x) {
        _PROPSHEETPAGEW_V1.hIcon$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle pszIcon$VH() {
        return _PROPSHEETPAGEW_V1.pszIcon$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pszIcon$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_PROPSHEETPAGEW_V1.pszIcon$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pszIcon$set(MemorySegment seg, MemorySegment x) {
        _PROPSHEETPAGEW_V1.pszIcon$VH.set(seg, x);
    }
    public static MemorySegment pszIcon$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_PROPSHEETPAGEW_V1.pszIcon$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pszIcon$set(MemorySegment seg, long index, MemorySegment x) {
        _PROPSHEETPAGEW_V1.pszIcon$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle pszTitle$VH() {
        return _PROPSHEETPAGEW_V1.pszTitle$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pszTitle$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_PROPSHEETPAGEW_V1.pszTitle$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pszTitle$set(MemorySegment seg, MemorySegment x) {
        _PROPSHEETPAGEW_V1.pszTitle$VH.set(seg, x);
    }
    public static MemorySegment pszTitle$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_PROPSHEETPAGEW_V1.pszTitle$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pszTitle$set(MemorySegment seg, long index, MemorySegment x) {
        _PROPSHEETPAGEW_V1.pszTitle$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle pfnDlgProc$VH() {
        return _PROPSHEETPAGEW_V1.pfnDlgProc$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pfnDlgProc$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_PROPSHEETPAGEW_V1.pfnDlgProc$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pfnDlgProc$set(MemorySegment seg, MemorySegment x) {
        _PROPSHEETPAGEW_V1.pfnDlgProc$VH.set(seg, x);
    }
    public static MemorySegment pfnDlgProc$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_PROPSHEETPAGEW_V1.pfnDlgProc$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pfnDlgProc$set(MemorySegment seg, long index, MemorySegment x) {
        _PROPSHEETPAGEW_V1.pfnDlgProc$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle lParam$VH() {
        return _PROPSHEETPAGEW_V1.lParam$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long lParam$get(MemorySegment seg) {
        return (long)_PROPSHEETPAGEW_V1.lParam$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lParam$set(MemorySegment seg, long x) {
        _PROPSHEETPAGEW_V1.lParam$VH.set(seg, x);
    }
    public static long lParam$get(MemorySegment seg, long index) {
        return (long)_PROPSHEETPAGEW_V1.lParam$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lParam$set(MemorySegment seg, long index, long x) {
        _PROPSHEETPAGEW_V1.lParam$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle pfnCallback$VH() {
        return _PROPSHEETPAGEW_V1.pfnCallback$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pfnCallback$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_PROPSHEETPAGEW_V1.pfnCallback$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pfnCallback$set(MemorySegment seg, MemorySegment x) {
        _PROPSHEETPAGEW_V1.pfnCallback$VH.set(seg, x);
    }
    public static MemorySegment pfnCallback$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_PROPSHEETPAGEW_V1.pfnCallback$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pfnCallback$set(MemorySegment seg, long index, MemorySegment x) {
        _PROPSHEETPAGEW_V1.pfnCallback$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle pcRefParent$VH() {
        return _PROPSHEETPAGEW_V1.pcRefParent$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pcRefParent$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_PROPSHEETPAGEW_V1.pcRefParent$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pcRefParent$set(MemorySegment seg, MemorySegment x) {
        _PROPSHEETPAGEW_V1.pcRefParent$VH.set(seg, x);
    }
    public static MemorySegment pcRefParent$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_PROPSHEETPAGEW_V1.pcRefParent$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pcRefParent$set(MemorySegment seg, long index, MemorySegment x) {
        _PROPSHEETPAGEW_V1.pcRefParent$VH.set(seg.asSlice(index*sizeof()), x);
    }
