...
public interface CS_TYPE_NET_SIZE_ROUTINE {
    ...
    static MemorySegment allocate(CS_TYPE_NET_SIZE_ROUTINE fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$812.CS_TYPE_NET_SIZE_ROUTINE_UP$MH, fi, constants$812.CS_TYPE_NET_SIZE_ROUTINE$FUNC, scope);
    }
    static CS_TYPE_NET_SIZE_ROUTINE ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _hBinding, int _ulNetworkCodeSet, int _ulNetworkBufferSize, java.lang.foreign.MemorySegment _conversionType, java.lang.foreign.MemorySegment _pulLocalBufferSize, java.lang.foreign.MemorySegment _pStatus) -> {
            try {
                constants$812.CS_TYPE_NET_SIZE_ROUTINE_DOWN$MH.invokeExact(symbol, _hBinding, _ulNetworkCodeSet, _ulNetworkBufferSize, _conversionType, _pulLocalBufferSize, _pStatus);
            } catch (Throwable ex$) {
