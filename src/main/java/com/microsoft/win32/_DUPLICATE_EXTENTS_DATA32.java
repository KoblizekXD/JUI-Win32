...
public class _DUPLICATE_EXTENTS_DATA32 {
    ...
    public static MemoryLayout $LAYOUT() {
        return _DUPLICATE_EXTENTS_DATA32.$struct$LAYOUT;
    }
    ...
    public static VarHandle FileHandle$VH() {
        return _DUPLICATE_EXTENTS_DATA32.FileHandle$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int FileHandle$get(MemorySegment seg) {
        return (int)_DUPLICATE_EXTENTS_DATA32.FileHandle$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void FileHandle$set(MemorySegment seg, int x) {
        _DUPLICATE_EXTENTS_DATA32.FileHandle$VH.set(seg, x);
    }
    public static int FileHandle$get(MemorySegment seg, long index) {
        return (int)_DUPLICATE_EXTENTS_DATA32.FileHandle$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void FileHandle$set(MemorySegment seg, long index, int x) {
        _DUPLICATE_EXTENTS_DATA32.FileHandle$VH.set(seg.asSlice(index*sizeof()), x);
    }
