...
public class _PRINTPROCESSOR_INFO_1W {
    ...
    public static MemoryLayout $LAYOUT() {
        return _PRINTPROCESSOR_INFO_1W.$struct$LAYOUT;
    }
    ...
    public static VarHandle pName$VH() {
        return _PRINTPROCESSOR_INFO_1W.pName$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_PRINTPROCESSOR_INFO_1W.pName$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pName$set(MemorySegment seg, MemorySegment x) {
        _PRINTPROCESSOR_INFO_1W.pName$VH.set(seg, x);
    }
    public static MemorySegment pName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_PRINTPROCESSOR_INFO_1W.pName$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pName$set(MemorySegment seg, long index, MemorySegment x) {
        _PRINTPROCESSOR_INFO_1W.pName$VH.set(seg.asSlice(index*sizeof()), x);
    }
