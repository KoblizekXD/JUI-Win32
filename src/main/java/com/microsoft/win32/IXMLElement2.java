...
public class IXMLElement2 {
    ...
    public static MemoryLayout $LAYOUT() {
        return IXMLElement2.$struct$LAYOUT;
    }
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)IXMLElement2.lpVtbl$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpVtbl$set(MemorySegment seg, MemorySegment x) {
        IXMLElement2.lpVtbl$VH.set(seg, x);
    }
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)IXMLElement2.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpVtbl$set(MemorySegment seg, long index, MemorySegment x) {
        IXMLElement2.lpVtbl$VH.set(seg.asSlice(index*sizeof()), x);
    }
