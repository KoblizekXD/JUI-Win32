...
public class _BCryptBufferDesc {
    ...
    public static MemorySegment pBuffers$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_BCryptBufferDesc.pBuffers$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pBuffers$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_BCryptBufferDesc.pBuffers$VH.get(seg.asSlice(index*sizeof()));
    }
