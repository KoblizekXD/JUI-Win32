...
public class IAddrTrackingControl {
    ...
    public static MemoryLayout $LAYOUT() {
        return IAddrTrackingControl.$struct$LAYOUT;
    }
    ...
    public static VarHandle lpVtbl$VH() {
        return IAddrTrackingControl.lpVtbl$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)IAddrTrackingControl.lpVtbl$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpVtbl$set(MemorySegment seg, MemorySegment x) {
        IAddrTrackingControl.lpVtbl$VH.set(seg, x);
    }
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)IAddrTrackingControl.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpVtbl$set(MemorySegment seg, long index, MemorySegment x) {
        IAddrTrackingControl.lpVtbl$VH.set(seg.asSlice(index*sizeof()), x);
    }
