...
public class IEnumMoniker {
    ...
    public static MemoryLayout $LAYOUT() {
        return IEnumMoniker.$struct$LAYOUT;
    }
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)IEnumMoniker.lpVtbl$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpVtbl$set(MemorySegment seg, MemorySegment x) {
        IEnumMoniker.lpVtbl$VH.set(seg, x);
    }
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)IEnumMoniker.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpVtbl$set(MemorySegment seg, long index, MemorySegment x) {
        IEnumMoniker.lpVtbl$VH.set(seg.asSlice(index*sizeof()), x);
    }
