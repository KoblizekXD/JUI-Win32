...
public class tagEMRPOLYLINE16 {
    ...
    public static MemoryLayout $LAYOUT() {
        return tagEMRPOLYLINE16.$struct$LAYOUT;
    }
    ...
    public static VarHandle cpts$VH() {
        return tagEMRPOLYLINE16.cpts$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int cpts$get(MemorySegment seg) {
        return (int)tagEMRPOLYLINE16.cpts$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cpts$set(MemorySegment seg, int x) {
        tagEMRPOLYLINE16.cpts$VH.set(seg, x);
    }
    public static int cpts$get(MemorySegment seg, long index) {
        return (int)tagEMRPOLYLINE16.cpts$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void cpts$set(MemorySegment seg, long index, int x) {
        tagEMRPOLYLINE16.cpts$VH.set(seg.asSlice(index*sizeof()), x);
    }
