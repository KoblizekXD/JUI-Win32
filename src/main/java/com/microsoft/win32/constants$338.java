...
final class constants$338 {
    ...
    static final MethodHandle ExtFloodFill$MH = RuntimeHelper.downcallHandle(
        "ExtFloodFill",
        constants$338.ExtFloodFill$FUNC
    );
    ...
    static final MethodHandle GetAspectRatioFilterEx$MH = RuntimeHelper.downcallHandle(
        ...
        constants$338.GetAspectRatioFilterEx$FUNC
    );
}
