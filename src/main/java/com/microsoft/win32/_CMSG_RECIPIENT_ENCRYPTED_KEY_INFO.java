...
public class _CMSG_RECIPIENT_ENCRYPTED_KEY_INFO {
    ...
    public static MemorySegment pOtherAttr$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CMSG_RECIPIENT_ENCRYPTED_KEY_INFO.pOtherAttr$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pOtherAttr$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CMSG_RECIPIENT_ENCRYPTED_KEY_INFO.pOtherAttr$VH.get(seg.asSlice(index*sizeof()));
    }
