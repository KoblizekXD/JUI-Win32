...
public class _OFNOTIFYEXA {
    ...
    public static MemorySegment lpOFN$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_OFNOTIFYEXA.lpOFN$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpOFN$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_OFNOTIFYEXA.lpOFN$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment psf$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_OFNOTIFYEXA.psf$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment psf$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_OFNOTIFYEXA.psf$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment pidl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_OFNOTIFYEXA.pidl$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pidl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_OFNOTIFYEXA.pidl$VH.get(seg.asSlice(index*sizeof()));
    }
