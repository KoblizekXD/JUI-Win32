...
public class _DEVICEDUMP_STORAGESTACK_PUBLIC_DUMP {
    ...
    static final StructLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(1, MemoryLayout.structLayout(
            MemoryLayout.sequenceLayout(16, Constants$root.C_CHAR$LAYOUT),
            MemoryLayout.sequenceLayout(16, Constants$root.C_CHAR$LAYOUT),
            Constants$root.C_LONG_LONG$LAYOUT.withBitAlignment(32).withName("StartTime"),
            Constants$root.C_LONG_LONG$LAYOUT.withBitAlignment(32).withName("EndTime"),
