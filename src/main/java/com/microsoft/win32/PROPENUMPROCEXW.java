...
public interface PROPENUMPROCEXW {
    ...
    static MemorySegment allocate(PROPENUMPROCEXW fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$392.PROPENUMPROCEXW_UP$MH, fi, constants$392.PROPENUMPROCEXW$FUNC, scope);
    }
    static PROPENUMPROCEXW ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment __x0, java.lang.foreign.MemorySegment __x1, java.lang.foreign.MemorySegment __x2, long __x3) -> {
            try {
                return (int)constants$393.PROPENUMPROCEXW_DOWN$MH.invokeExact(symbol, __x0, __x1, __x2, __x3);
            } catch (Throwable ex$) {
