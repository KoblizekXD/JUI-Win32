...
public class _EXCEPTION_POINTERS {
    ...
    public static MemorySegment ExceptionRecord$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_EXCEPTION_POINTERS.ExceptionRecord$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment ExceptionRecord$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_EXCEPTION_POINTERS.ExceptionRecord$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment ContextRecord$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_EXCEPTION_POINTERS.ContextRecord$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment ContextRecord$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_EXCEPTION_POINTERS.ContextRecord$VH.get(seg.asSlice(index*sizeof()));
    }
