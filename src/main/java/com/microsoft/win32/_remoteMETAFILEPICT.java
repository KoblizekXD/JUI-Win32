...
public class _remoteMETAFILEPICT {
    ...
    public static MemorySegment hMF$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_remoteMETAFILEPICT.hMF$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment hMF$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_remoteMETAFILEPICT.hMF$VH.get(seg.asSlice(index*sizeof()));
    }
