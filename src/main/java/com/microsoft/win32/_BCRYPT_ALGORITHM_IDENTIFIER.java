...
public class _BCRYPT_ALGORITHM_IDENTIFIER {
    ...
    public static MemorySegment pszName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_BCRYPT_ALGORITHM_IDENTIFIER.pszName$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pszName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_BCRYPT_ALGORITHM_IDENTIFIER.pszName$VH.get(seg.asSlice(index*sizeof()));
    }
