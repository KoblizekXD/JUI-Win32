...
public class tagCALPSTR {
    ...
    public static MemorySegment pElems$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagCALPSTR.pElems$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pElems$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagCALPSTR.pElems$VH.get(seg.asSlice(index*sizeof()));
    }
