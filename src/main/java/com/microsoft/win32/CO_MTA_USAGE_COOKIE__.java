...
public class CO_MTA_USAGE_COOKIE__ {
    ...
    public static MemoryLayout $LAYOUT() {
        return CO_MTA_USAGE_COOKIE__.$struct$LAYOUT;
    }
    ...
    public static VarHandle unused$VH() {
        return CO_MTA_USAGE_COOKIE__.unused$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int unused$get(MemorySegment seg) {
        return (int)CO_MTA_USAGE_COOKIE__.unused$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void unused$set(MemorySegment seg, int x) {
        CO_MTA_USAGE_COOKIE__.unused$VH.set(seg, x);
    }
    public static int unused$get(MemorySegment seg, long index) {
        return (int)CO_MTA_USAGE_COOKIE__.unused$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void unused$set(MemorySegment seg, long index, int x) {
        CO_MTA_USAGE_COOKIE__.unused$VH.set(seg.asSlice(index*sizeof()), x);
    }
