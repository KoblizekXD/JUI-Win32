...
final class constants$584 {
    ...
    static final MethodHandle WNetUseConnectionA$MH = RuntimeHelper.downcallHandle(
        "WNetUseConnectionA",
        constants$584.WNetUseConnectionA$FUNC
    );
    ...
    static final MethodHandle WNetUseConnectionW$MH = RuntimeHelper.downcallHandle(
        "WNetUseConnectionW",
        constants$584.WNetUseConnectionW$FUNC
    );
    ...
    static final MethodHandle WNetUseConnection4A$MH = RuntimeHelper.downcallHandle(
        "WNetUseConnection4A",
        constants$584.WNetUseConnection4A$FUNC
    );
    ...
    static final MethodHandle WNetUseConnection4W$MH = RuntimeHelper.downcallHandle(
        "WNetUseConnection4W",
        constants$584.WNetUseConnection4W$FUNC
    );
    ...
    static final MethodHandle WNetConnectionDialog$MH = RuntimeHelper.downcallHandle(
        ...
        constants$584.WNetConnectionDialog$FUNC
    );
    ...
    static final MethodHandle WNetDisconnectDialog$MH = RuntimeHelper.downcallHandle(
        ...
        constants$584.WNetDisconnectDialog$FUNC
    );
}
