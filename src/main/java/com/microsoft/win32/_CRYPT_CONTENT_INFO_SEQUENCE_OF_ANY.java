...
public class _CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY {
    ...
    public static MemoryLayout $LAYOUT() {
        return _CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.$struct$LAYOUT;
    }
    ...
    public static VarHandle pszObjId$VH() {
        return _CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.pszObjId$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pszObjId$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.pszObjId$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pszObjId$set(MemorySegment seg, MemorySegment x) {
        _CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.pszObjId$VH.set(seg, x);
    }
    public static MemorySegment pszObjId$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pszObjId$set(MemorySegment seg, long index, MemorySegment x) {
        _CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.pszObjId$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle cValue$VH() {
        return _CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.cValue$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int cValue$get(MemorySegment seg) {
        return (int)_CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.cValue$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cValue$set(MemorySegment seg, int x) {
        _CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.cValue$VH.set(seg, x);
    }
    public static int cValue$get(MemorySegment seg, long index) {
        return (int)_CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.cValue$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void cValue$set(MemorySegment seg, long index, int x) {
        _CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.cValue$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle rgValue$VH() {
        return _CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.rgValue$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment rgValue$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.rgValue$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void rgValue$set(MemorySegment seg, MemorySegment x) {
        _CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.rgValue$VH.set(seg, x);
    }
    public static MemorySegment rgValue$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.rgValue$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void rgValue$set(MemorySegment seg, long index, MemorySegment x) {
        _CRYPT_CONTENT_INFO_SEQUENCE_OF_ANY.rgValue$VH.set(seg.asSlice(index*sizeof()), x);
    }
