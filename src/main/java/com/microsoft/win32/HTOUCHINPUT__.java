...
public class HTOUCHINPUT__ {
    ...
    public static MemoryLayout $LAYOUT() {
        return HTOUCHINPUT__.$struct$LAYOUT;
    }
    ...
    public static VarHandle unused$VH() {
        return HTOUCHINPUT__.unused$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int unused$get(MemorySegment seg) {
        return (int)HTOUCHINPUT__.unused$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void unused$set(MemorySegment seg, int x) {
        HTOUCHINPUT__.unused$VH.set(seg, x);
    }
    public static int unused$get(MemorySegment seg, long index) {
        return (int)HTOUCHINPUT__.unused$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void unused$set(MemorySegment seg, long index, int x) {
        HTOUCHINPUT__.unused$VH.set(seg.asSlice(index*sizeof()), x);
    }
