...
final class constants$121 {
    ...
    static final MethodHandle FlushFileBuffers$MH = RuntimeHelper.downcallHandle(
        "FlushFileBuffers",
        constants$121.FlushFileBuffers$FUNC
    );
    ...
    static final MethodHandle GetDiskFreeSpaceA$MH = RuntimeHelper.downcallHandle(
        "GetDiskFreeSpaceA",
        constants$121.GetDiskFreeSpaceA$FUNC
    );
    ...
    static final MethodHandle GetDiskFreeSpaceW$MH = RuntimeHelper.downcallHandle(
        "GetDiskFreeSpaceW",
        constants$121.GetDiskFreeSpaceW$FUNC
    );
    ...
    static final MethodHandle GetDiskFreeSpaceExA$MH = RuntimeHelper.downcallHandle(
        "GetDiskFreeSpaceExA",
        constants$121.GetDiskFreeSpaceExA$FUNC
    );
    ...
    static final MethodHandle GetDiskFreeSpaceExW$MH = RuntimeHelper.downcallHandle(
        "GetDiskFreeSpaceExW",
        constants$121.GetDiskFreeSpaceExW$FUNC
    );
    ...
    static final MethodHandle GetDiskSpaceInformationA$MH = RuntimeHelper.downcallHandle(
        ...
        constants$121.GetDiskSpaceInformationA$FUNC
    );
}
