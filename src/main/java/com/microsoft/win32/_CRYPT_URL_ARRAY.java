...
public class _CRYPT_URL_ARRAY {
    ...
    public static MemorySegment rgwszUrl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CRYPT_URL_ARRAY.rgwszUrl$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment rgwszUrl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CRYPT_URL_ARRAY.rgwszUrl$VH.get(seg.asSlice(index*sizeof()));
    }
