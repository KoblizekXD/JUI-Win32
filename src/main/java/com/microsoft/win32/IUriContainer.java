...
public class IUriContainer {
    ...
    public static MemoryLayout $LAYOUT() {
        return IUriContainer.$struct$LAYOUT;
    }
    ...
    public static VarHandle lpVtbl$VH() {
        return IUriContainer.lpVtbl$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)IUriContainer.lpVtbl$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpVtbl$set(MemorySegment seg, MemorySegment x) {
        IUriContainer.lpVtbl$VH.set(seg, x);
    }
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)IUriContainer.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpVtbl$set(MemorySegment seg, long index, MemorySegment x) {
        IUriContainer.lpVtbl$VH.set(seg.asSlice(index*sizeof()), x);
    }
