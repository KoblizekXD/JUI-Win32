...
final class constants$623 {
    ...
    static final MethodHandle midiInGetNumDevs$MH = RuntimeHelper.downcallHandle(
        "midiInGetNumDevs",
        constants$623.midiInGetNumDevs$FUNC
    );
    ...
    static final MethodHandle midiInGetDevCapsA$MH = RuntimeHelper.downcallHandle(
        "midiInGetDevCapsA",
        constants$623.midiInGetDevCapsA$FUNC
    );
    ...
    static final MethodHandle midiInGetDevCapsW$MH = RuntimeHelper.downcallHandle(
        "midiInGetDevCapsW",
        constants$623.midiInGetDevCapsW$FUNC
    );
    ...
    static final MethodHandle midiInGetErrorTextA$MH = RuntimeHelper.downcallHandle(
        "midiInGetErrorTextA",
        constants$623.midiInGetErrorTextA$FUNC
    );
    ...
    static final MethodHandle midiInGetErrorTextW$MH = RuntimeHelper.downcallHandle(
        "midiInGetErrorTextW",
        constants$623.midiInGetErrorTextW$FUNC
    );
