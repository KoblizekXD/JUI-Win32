...
final class constants$316 {
    ...
    static final FunctionDescriptor PQUERYACTCTXW_FUNC_DOWN$FUNC = FunctionDescriptor.of(Constants$root.C_LONG$LAYOUT,
    ...
    static final MethodHandle PQUERYACTCTXW_FUNC_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$316.PQUERYACTCTXW_FUNC_DOWN$FUNC
    );
    ...
    static final MethodHandle WTSGetActiveConsoleSessionId$MH = RuntimeHelper.downcallHandle(
        ...
        constants$316.WTSGetActiveConsoleSessionId$FUNC
    );
    ...
    static final MethodHandle WTSGetServiceSessionId$MH = RuntimeHelper.downcallHandle(
        ...
        constants$316.WTSGetServiceSessionId$FUNC
    );
    ...
    static final MethodHandle WTSIsServerContainer$MH = RuntimeHelper.downcallHandle(
        ...
        constants$316.WTSIsServerContainer$FUNC
    );
    ...
    static final MethodHandle GetActiveProcessorGroupCount$MH = RuntimeHelper.downcallHandle(
        ...
        constants$316.GetActiveProcessorGroupCount$FUNC
    );
    ...
    static final MethodHandle GetMaximumProcessorGroupCount$MH = RuntimeHelper.downcallHandle(
        ...
        constants$316.GetMaximumProcessorGroupCount$FUNC
    );
}
