...
public class _BIDI_RESPONSE_DATA {
    ...
    public static MemorySegment pSchema$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_BIDI_RESPONSE_DATA.pSchema$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pSchema$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_BIDI_RESPONSE_DATA.pSchema$VH.get(seg.asSlice(index*sizeof()));
    }
