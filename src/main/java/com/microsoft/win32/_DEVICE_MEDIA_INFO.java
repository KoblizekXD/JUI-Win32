...
public class _DEVICE_MEDIA_INFO {
    ...
    public static final class DeviceSpecific {
        ...
        static final UnionLayout DeviceSpecific$union$LAYOUT = MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                MemoryLayout.unionLayout(
                    MemoryLayout.structLayout(
                        Constants$root.C_LONG$LAYOUT.withName("LowPart"),
        ...
        public static final class DiskInfo {
            ...
            // Suppresses default constructor, ensuring non-instantiability.
            private DiskInfo() {}
            static final StructLayout DeviceSpecific$DiskInfo$struct$LAYOUT = MemoryLayout.structLayout(
                MemoryLayout.unionLayout(
                    MemoryLayout.structLayout(
                        Constants$root.C_LONG$LAYOUT.withName("LowPart"),
                        Constants$root.C_LONG$LAYOUT.withName("HighPart")
        ...
        public static final class RemovableDiskInfo {
            ...
            static final StructLayout DeviceSpecific$RemovableDiskInfo$struct$LAYOUT = MemoryLayout.structLayout(
                MemoryLayout.unionLayout(
                    MemoryLayout.structLayout(
                        Constants$root.C_LONG$LAYOUT.withName("LowPart"),
                        Constants$root.C_LONG$LAYOUT.withName("HighPart")
        ...
        public static final class TapeInfo {
            ...
            // Suppresses default constructor, ensuring non-instantiability.
            private TapeInfo() {}
            static final StructLayout DeviceSpecific$TapeInfo$struct$LAYOUT = MemoryLayout.structLayout(
                Constants$root.C_LONG$LAYOUT.withName("MediaType"),
                Constants$root.C_LONG$LAYOUT.withName("MediaCharacteristics"),
                Constants$root.C_LONG$LAYOUT.withName("CurrentBlockSize"),
                Constants$root.C_LONG$LAYOUT.withName("BusType"),
            ...
            public static final class BusSpecificData {
                ...
                static final UnionLayout DeviceSpecific$TapeInfo$BusSpecificData$union$LAYOUT = MemoryLayout.unionLayout(
                    MemoryLayout.structLayout(
                        Constants$root.C_CHAR$LAYOUT.withName("MediumType"),
                        Constants$root.C_CHAR$LAYOUT.withName("DensityCode")
                    ).withName("ScsiInformation")
                ...
                public static final class ScsiInformation {
                    ...
                    static final StructLayout DeviceSpecific$TapeInfo$BusSpecificData$ScsiInformation$struct$LAYOUT = MemoryLayout.structLayout(
                        Constants$root.C_CHAR$LAYOUT.withName("MediumType"),
                        Constants$root.C_CHAR$LAYOUT.withName("DensityCode")
                    );
                    public static MemoryLayout $LAYOUT() {
