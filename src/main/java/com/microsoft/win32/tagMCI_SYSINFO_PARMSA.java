...
public class tagMCI_SYSINFO_PARMSA {
    ...
    public static MemorySegment lpstrReturn$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagMCI_SYSINFO_PARMSA.lpstrReturn$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpstrReturn$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagMCI_SYSINFO_PARMSA.lpstrReturn$VH.get(seg.asSlice(index*sizeof()));
    }
