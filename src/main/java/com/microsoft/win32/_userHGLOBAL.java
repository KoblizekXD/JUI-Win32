...
public class _userHGLOBAL {
    ...
    public static final class __MIDL_IWinTypes_0003 {
        ...
        static final UnionLayout __MIDL_IWinTypes_0003$union$LAYOUT = MemoryLayout.unionLayout(
            Constants$root.C_LONG$LAYOUT.withName("hInproc"),
            Constants$root.C_POINTER$LAYOUT.withName("hRemote"),
            Constants$root.C_LONG_LONG$LAYOUT.withName("hInproc64")
        ...
        public static MemorySegment hRemote$get(MemorySegment seg) {
            return (java.lang.foreign.MemorySegment)__MIDL_IWinTypes_0003.hRemote$VH.get(seg);
        }
        /**
         * Setter for field:
         * {@snippet :
        ...
        public static MemorySegment hRemote$get(MemorySegment seg, long index) {
            return (java.lang.foreign.MemorySegment)__MIDL_IWinTypes_0003.hRemote$VH.get(seg.asSlice(index*sizeof()));
        }
