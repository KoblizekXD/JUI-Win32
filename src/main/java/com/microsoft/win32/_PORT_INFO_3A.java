...
public class _PORT_INFO_3A {
    ...
    public static MemorySegment pszStatus$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_PORT_INFO_3A.pszStatus$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pszStatus$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_PORT_INFO_3A.pszStatus$VH.get(seg.asSlice(index*sizeof()));
    }
