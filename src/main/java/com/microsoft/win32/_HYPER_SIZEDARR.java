...
public class _HYPER_SIZEDARR {
    ...
    public static MemorySegment pData$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_HYPER_SIZEDARR.pData$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pData$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_HYPER_SIZEDARR.pData$VH.get(seg.asSlice(index*sizeof()));
    }
