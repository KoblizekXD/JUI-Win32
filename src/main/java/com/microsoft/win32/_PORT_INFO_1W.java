...
public class _PORT_INFO_1W {
    ...
    public static MemorySegment pName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_PORT_INFO_1W.pName$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_PORT_INFO_1W.pName$VH.get(seg.asSlice(index*sizeof()));
    }
