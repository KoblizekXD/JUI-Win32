...
public class _MIDL_WINRT_TYPE_SERIALIZATION_INFO {
    ...
    public static MemorySegment TypeFormatString$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_MIDL_WINRT_TYPE_SERIALIZATION_INFO.TypeFormatString$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment TypeFormatString$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_MIDL_WINRT_TYPE_SERIALIZATION_INFO.TypeFormatString$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment StubDesc$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_MIDL_WINRT_TYPE_SERIALIZATION_INFO.StubDesc$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment StubDesc$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_MIDL_WINRT_TYPE_SERIALIZATION_INFO.StubDesc$VH.get(seg.asSlice(index*sizeof()));
    }
