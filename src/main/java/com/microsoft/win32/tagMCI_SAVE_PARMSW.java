...
public class tagMCI_SAVE_PARMSW {
    ...
    public static MemorySegment lpfilename$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagMCI_SAVE_PARMSW.lpfilename$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpfilename$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagMCI_SAVE_PARMSW.lpfilename$VH.get(seg.asSlice(index*sizeof()));
    }
