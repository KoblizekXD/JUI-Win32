...
public class tagMCI_RECORD_PARMS {
    ...
    public static MemoryLayout $LAYOUT() {
        return tagMCI_RECORD_PARMS.$struct$LAYOUT;
    }
    ...
    public static VarHandle dwCallback$VH() {
        return tagMCI_RECORD_PARMS.dwCallback$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long dwCallback$get(MemorySegment seg) {
        return (long)tagMCI_RECORD_PARMS.dwCallback$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwCallback$set(MemorySegment seg, long x) {
        tagMCI_RECORD_PARMS.dwCallback$VH.set(seg, x);
    }
    public static long dwCallback$get(MemorySegment seg, long index) {
        return (long)tagMCI_RECORD_PARMS.dwCallback$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwCallback$set(MemorySegment seg, long index, long x) {
        tagMCI_RECORD_PARMS.dwCallback$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwFrom$VH() {
        return tagMCI_RECORD_PARMS.dwFrom$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwFrom$get(MemorySegment seg) {
        return (int)tagMCI_RECORD_PARMS.dwFrom$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwFrom$set(MemorySegment seg, int x) {
        tagMCI_RECORD_PARMS.dwFrom$VH.set(seg, x);
    }
    public static int dwFrom$get(MemorySegment seg, long index) {
        return (int)tagMCI_RECORD_PARMS.dwFrom$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwFrom$set(MemorySegment seg, long index, int x) {
        tagMCI_RECORD_PARMS.dwFrom$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwTo$VH() {
        return tagMCI_RECORD_PARMS.dwTo$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwTo$get(MemorySegment seg) {
        return (int)tagMCI_RECORD_PARMS.dwTo$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwTo$set(MemorySegment seg, int x) {
        tagMCI_RECORD_PARMS.dwTo$VH.set(seg, x);
    }
    public static int dwTo$get(MemorySegment seg, long index) {
        return (int)tagMCI_RECORD_PARMS.dwTo$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwTo$set(MemorySegment seg, long index, int x) {
        tagMCI_RECORD_PARMS.dwTo$VH.set(seg.asSlice(index*sizeof()), x);
    }
