...
public class _PORT_INFO_1A {
    ...
    public static MemoryLayout $LAYOUT() {
        return _PORT_INFO_1A.$struct$LAYOUT;
    }
    ...
    public static MemorySegment pName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_PORT_INFO_1A.pName$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pName$set(MemorySegment seg, MemorySegment x) {
        _PORT_INFO_1A.pName$VH.set(seg, x);
    }
    public static MemorySegment pName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_PORT_INFO_1A.pName$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pName$set(MemorySegment seg, long index, MemorySegment x) {
        _PORT_INFO_1A.pName$VH.set(seg.asSlice(index*sizeof()), x);
    }
