...
public class tagCAFILETIME {
    ...
    public static MemoryLayout $LAYOUT() {
        return tagCAFILETIME.$struct$LAYOUT;
    }
    ...
    public static VarHandle cElems$VH() {
        return tagCAFILETIME.cElems$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int cElems$get(MemorySegment seg) {
        return (int)tagCAFILETIME.cElems$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cElems$set(MemorySegment seg, int x) {
        tagCAFILETIME.cElems$VH.set(seg, x);
    }
    public static int cElems$get(MemorySegment seg, long index) {
        return (int)tagCAFILETIME.cElems$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void cElems$set(MemorySegment seg, long index, int x) {
        tagCAFILETIME.cElems$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle pElems$VH() {
        return tagCAFILETIME.pElems$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pElems$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagCAFILETIME.pElems$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pElems$set(MemorySegment seg, MemorySegment x) {
        tagCAFILETIME.pElems$VH.set(seg, x);
    }
    public static MemorySegment pElems$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagCAFILETIME.pElems$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pElems$set(MemorySegment seg, long index, MemorySegment x) {
        tagCAFILETIME.pElems$VH.set(seg.asSlice(index*sizeof()), x);
    }
