...
public class tagWAVEOUTCAPS2A {
    ...
    public static MemoryLayout $LAYOUT() {
        return tagWAVEOUTCAPS2A.$struct$LAYOUT;
    }
    ...
    public static VarHandle wMid$VH() {
        return tagWAVEOUTCAPS2A.wMid$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static short wMid$get(MemorySegment seg) {
        return (short)tagWAVEOUTCAPS2A.wMid$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void wMid$set(MemorySegment seg, short x) {
        tagWAVEOUTCAPS2A.wMid$VH.set(seg, x);
    }
    public static short wMid$get(MemorySegment seg, long index) {
        return (short)tagWAVEOUTCAPS2A.wMid$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void wMid$set(MemorySegment seg, long index, short x) {
        tagWAVEOUTCAPS2A.wMid$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle wPid$VH() {
        return tagWAVEOUTCAPS2A.wPid$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static short wPid$get(MemorySegment seg) {
        return (short)tagWAVEOUTCAPS2A.wPid$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void wPid$set(MemorySegment seg, short x) {
        tagWAVEOUTCAPS2A.wPid$VH.set(seg, x);
    }
    public static short wPid$get(MemorySegment seg, long index) {
        return (short)tagWAVEOUTCAPS2A.wPid$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void wPid$set(MemorySegment seg, long index, short x) {
        tagWAVEOUTCAPS2A.wPid$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle vDriverVersion$VH() {
        return tagWAVEOUTCAPS2A.vDriverVersion$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int vDriverVersion$get(MemorySegment seg) {
        return (int)tagWAVEOUTCAPS2A.vDriverVersion$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void vDriverVersion$set(MemorySegment seg, int x) {
        tagWAVEOUTCAPS2A.vDriverVersion$VH.set(seg, x);
    }
    public static int vDriverVersion$get(MemorySegment seg, long index) {
        return (int)tagWAVEOUTCAPS2A.vDriverVersion$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void vDriverVersion$set(MemorySegment seg, long index, int x) {
        tagWAVEOUTCAPS2A.vDriverVersion$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwFormats$VH() {
        return tagWAVEOUTCAPS2A.dwFormats$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwFormats$get(MemorySegment seg) {
        return (int)tagWAVEOUTCAPS2A.dwFormats$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwFormats$set(MemorySegment seg, int x) {
        tagWAVEOUTCAPS2A.dwFormats$VH.set(seg, x);
    }
    public static int dwFormats$get(MemorySegment seg, long index) {
        return (int)tagWAVEOUTCAPS2A.dwFormats$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwFormats$set(MemorySegment seg, long index, int x) {
        tagWAVEOUTCAPS2A.dwFormats$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle wChannels$VH() {
        return tagWAVEOUTCAPS2A.wChannels$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static short wChannels$get(MemorySegment seg) {
        return (short)tagWAVEOUTCAPS2A.wChannels$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void wChannels$set(MemorySegment seg, short x) {
        tagWAVEOUTCAPS2A.wChannels$VH.set(seg, x);
    }
    public static short wChannels$get(MemorySegment seg, long index) {
        return (short)tagWAVEOUTCAPS2A.wChannels$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void wChannels$set(MemorySegment seg, long index, short x) {
        tagWAVEOUTCAPS2A.wChannels$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle wReserved1$VH() {
        return tagWAVEOUTCAPS2A.wReserved1$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static short wReserved1$get(MemorySegment seg) {
        return (short)tagWAVEOUTCAPS2A.wReserved1$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void wReserved1$set(MemorySegment seg, short x) {
        tagWAVEOUTCAPS2A.wReserved1$VH.set(seg, x);
    }
    public static short wReserved1$get(MemorySegment seg, long index) {
        return (short)tagWAVEOUTCAPS2A.wReserved1$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void wReserved1$set(MemorySegment seg, long index, short x) {
        tagWAVEOUTCAPS2A.wReserved1$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwSupport$VH() {
        return tagWAVEOUTCAPS2A.dwSupport$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwSupport$get(MemorySegment seg) {
        return (int)tagWAVEOUTCAPS2A.dwSupport$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwSupport$set(MemorySegment seg, int x) {
        tagWAVEOUTCAPS2A.dwSupport$VH.set(seg, x);
    }
    public static int dwSupport$get(MemorySegment seg, long index) {
        return (int)tagWAVEOUTCAPS2A.dwSupport$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwSupport$set(MemorySegment seg, long index, int x) {
        tagWAVEOUTCAPS2A.dwSupport$VH.set(seg.asSlice(index*sizeof()), x);
    }
