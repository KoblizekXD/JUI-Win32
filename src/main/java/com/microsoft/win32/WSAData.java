...
public class WSAData {
    ...
    public static MemorySegment lpVendorInfo$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)WSAData.lpVendorInfo$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpVendorInfo$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)WSAData.lpVendorInfo$VH.get(seg.asSlice(index*sizeof()));
    }
