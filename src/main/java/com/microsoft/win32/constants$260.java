...
final class constants$260 {
    ...
    static final MethodHandle CreateMailslotA$MH = RuntimeHelper.downcallHandle(
        "CreateMailslotA",
        constants$260.CreateMailslotA$FUNC
    );
    ...
    static final MethodHandle CreateMailslotW$MH = RuntimeHelper.downcallHandle(
        "CreateMailslotW",
        constants$260.CreateMailslotW$FUNC
    );
    ...
    static final MethodHandle GetMailslotInfo$MH = RuntimeHelper.downcallHandle(
        "GetMailslotInfo",
        constants$260.GetMailslotInfo$FUNC
    );
    ...
    static final MethodHandle SetMailslotInfo$MH = RuntimeHelper.downcallHandle(
        "SetMailslotInfo",
        constants$260.SetMailslotInfo$FUNC
    );
    ...
    static final MethodHandle EncryptFileA$MH = RuntimeHelper.downcallHandle(
        "EncryptFileA",
        constants$260.EncryptFileA$FUNC
    );
    ...
    static final MethodHandle EncryptFileW$MH = RuntimeHelper.downcallHandle(
        "EncryptFileW",
        constants$260.EncryptFileW$FUNC
    );
}
