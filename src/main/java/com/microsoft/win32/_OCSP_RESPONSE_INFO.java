...
public class _OCSP_RESPONSE_INFO {
    ...
    public static MemoryLayout $LAYOUT() {
        return _OCSP_RESPONSE_INFO.$struct$LAYOUT;
    }
    ...
    public static VarHandle dwStatus$VH() {
        return _OCSP_RESPONSE_INFO.dwStatus$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwStatus$get(MemorySegment seg) {
        return (int)_OCSP_RESPONSE_INFO.dwStatus$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwStatus$set(MemorySegment seg, int x) {
        _OCSP_RESPONSE_INFO.dwStatus$VH.set(seg, x);
    }
    public static int dwStatus$get(MemorySegment seg, long index) {
        return (int)_OCSP_RESPONSE_INFO.dwStatus$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwStatus$set(MemorySegment seg, long index, int x) {
        _OCSP_RESPONSE_INFO.dwStatus$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle pszObjId$VH() {
        return _OCSP_RESPONSE_INFO.pszObjId$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pszObjId$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_OCSP_RESPONSE_INFO.pszObjId$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pszObjId$set(MemorySegment seg, MemorySegment x) {
        _OCSP_RESPONSE_INFO.pszObjId$VH.set(seg, x);
    }
    public static MemorySegment pszObjId$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_OCSP_RESPONSE_INFO.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pszObjId$set(MemorySegment seg, long index, MemorySegment x) {
        _OCSP_RESPONSE_INFO.pszObjId$VH.set(seg.asSlice(index*sizeof()), x);
    }
