...
public class IAsyncRpcChannelBuffer {
    ...
    public static MemoryLayout $LAYOUT() {
        return IAsyncRpcChannelBuffer.$struct$LAYOUT;
    }
    ...
    public static VarHandle lpVtbl$VH() {
        return IAsyncRpcChannelBuffer.lpVtbl$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)IAsyncRpcChannelBuffer.lpVtbl$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpVtbl$set(MemorySegment seg, MemorySegment x) {
        IAsyncRpcChannelBuffer.lpVtbl$VH.set(seg, x);
    }
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)IAsyncRpcChannelBuffer.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpVtbl$set(MemorySegment seg, long index, MemorySegment x) {
        IAsyncRpcChannelBuffer.lpVtbl$VH.set(seg.asSlice(index*sizeof()), x);
    }
