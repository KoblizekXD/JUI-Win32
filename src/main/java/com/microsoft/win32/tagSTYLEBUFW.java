...
public class tagSTYLEBUFW {
    ...
    static final StructLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(32, Constants$root.C_SHORT$LAYOUT).withName("szDescription")
    ).withName("tagSTYLEBUFW");
    public static MemoryLayout $LAYOUT() {
        return tagSTYLEBUFW.$struct$LAYOUT;
    }
    ...
    public static VarHandle dwStyle$VH() {
        return tagSTYLEBUFW.dwStyle$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwStyle$get(MemorySegment seg) {
        return (int)tagSTYLEBUFW.dwStyle$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwStyle$set(MemorySegment seg, int x) {
        tagSTYLEBUFW.dwStyle$VH.set(seg, x);
    }
    public static int dwStyle$get(MemorySegment seg, long index) {
        return (int)tagSTYLEBUFW.dwStyle$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwStyle$set(MemorySegment seg, long index, int x) {
        tagSTYLEBUFW.dwStyle$VH.set(seg.asSlice(index*sizeof()), x);
    }
