...
public class _IMAGE_DYNAMIC_RELOCATION32_V2 {
    ...
    public static MemoryLayout $LAYOUT() {
        return _IMAGE_DYNAMIC_RELOCATION32_V2.$struct$LAYOUT;
    }
    ...
    public static VarHandle HeaderSize$VH() {
        return _IMAGE_DYNAMIC_RELOCATION32_V2.HeaderSize$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int HeaderSize$get(MemorySegment seg) {
        return (int)_IMAGE_DYNAMIC_RELOCATION32_V2.HeaderSize$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void HeaderSize$set(MemorySegment seg, int x) {
        _IMAGE_DYNAMIC_RELOCATION32_V2.HeaderSize$VH.set(seg, x);
    }
    public static int HeaderSize$get(MemorySegment seg, long index) {
        return (int)_IMAGE_DYNAMIC_RELOCATION32_V2.HeaderSize$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void HeaderSize$set(MemorySegment seg, long index, int x) {
        _IMAGE_DYNAMIC_RELOCATION32_V2.HeaderSize$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle FixupInfoSize$VH() {
        return _IMAGE_DYNAMIC_RELOCATION32_V2.FixupInfoSize$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int FixupInfoSize$get(MemorySegment seg) {
        return (int)_IMAGE_DYNAMIC_RELOCATION32_V2.FixupInfoSize$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void FixupInfoSize$set(MemorySegment seg, int x) {
        _IMAGE_DYNAMIC_RELOCATION32_V2.FixupInfoSize$VH.set(seg, x);
    }
    public static int FixupInfoSize$get(MemorySegment seg, long index) {
        return (int)_IMAGE_DYNAMIC_RELOCATION32_V2.FixupInfoSize$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void FixupInfoSize$set(MemorySegment seg, long index, int x) {
        _IMAGE_DYNAMIC_RELOCATION32_V2.FixupInfoSize$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle Symbol$VH() {
        return _IMAGE_DYNAMIC_RELOCATION32_V2.Symbol$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int Symbol$get(MemorySegment seg) {
        return (int)_IMAGE_DYNAMIC_RELOCATION32_V2.Symbol$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Symbol$set(MemorySegment seg, int x) {
        _IMAGE_DYNAMIC_RELOCATION32_V2.Symbol$VH.set(seg, x);
    }
    public static int Symbol$get(MemorySegment seg, long index) {
        return (int)_IMAGE_DYNAMIC_RELOCATION32_V2.Symbol$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void Symbol$set(MemorySegment seg, long index, int x) {
        _IMAGE_DYNAMIC_RELOCATION32_V2.Symbol$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle SymbolGroup$VH() {
        return _IMAGE_DYNAMIC_RELOCATION32_V2.SymbolGroup$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int SymbolGroup$get(MemorySegment seg) {
        return (int)_IMAGE_DYNAMIC_RELOCATION32_V2.SymbolGroup$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void SymbolGroup$set(MemorySegment seg, int x) {
        _IMAGE_DYNAMIC_RELOCATION32_V2.SymbolGroup$VH.set(seg, x);
    }
    public static int SymbolGroup$get(MemorySegment seg, long index) {
        return (int)_IMAGE_DYNAMIC_RELOCATION32_V2.SymbolGroup$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void SymbolGroup$set(MemorySegment seg, long index, int x) {
        _IMAGE_DYNAMIC_RELOCATION32_V2.SymbolGroup$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle Flags$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("Flags"));
    public static VarHandle Flags$VH() {
        return _IMAGE_DYNAMIC_RELOCATION32_V2.Flags$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int Flags$get(MemorySegment seg) {
        return (int)_IMAGE_DYNAMIC_RELOCATION32_V2.Flags$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Flags$set(MemorySegment seg, int x) {
        _IMAGE_DYNAMIC_RELOCATION32_V2.Flags$VH.set(seg, x);
    }
    public static int Flags$get(MemorySegment seg, long index) {
        return (int)_IMAGE_DYNAMIC_RELOCATION32_V2.Flags$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void Flags$set(MemorySegment seg, long index, int x) {
        _IMAGE_DYNAMIC_RELOCATION32_V2.Flags$VH.set(seg.asSlice(index*sizeof()), x);
    }
