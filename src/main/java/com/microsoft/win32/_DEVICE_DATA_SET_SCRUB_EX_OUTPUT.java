...
public class _DEVICE_DATA_SET_SCRUB_EX_OUTPUT {
    ...
    static final StructLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        Constants$root.C_LONG_LONG$LAYOUT.withName("BytesScrubbed")
    ...
    static final VarHandle BytesScrubbed$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("BytesScrubbed"));
    public static VarHandle BytesScrubbed$VH() {
        return _DEVICE_DATA_SET_SCRUB_EX_OUTPUT.BytesScrubbed$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long BytesScrubbed$get(MemorySegment seg) {
        return (long)_DEVICE_DATA_SET_SCRUB_EX_OUTPUT.BytesScrubbed$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void BytesScrubbed$set(MemorySegment seg, long x) {
        _DEVICE_DATA_SET_SCRUB_EX_OUTPUT.BytesScrubbed$VH.set(seg, x);
    }
    public static long BytesScrubbed$get(MemorySegment seg, long index) {
        return (long)_DEVICE_DATA_SET_SCRUB_EX_OUTPUT.BytesScrubbed$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void BytesScrubbed$set(MemorySegment seg, long index, long x) {
        _DEVICE_DATA_SET_SCRUB_EX_OUTPUT.BytesScrubbed$VH.set(seg.asSlice(index*sizeof()), x);
    }
