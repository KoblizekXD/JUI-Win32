...
public class HINSTANCE__ {
    ...
    public static MemoryLayout $LAYOUT() {
        return HINSTANCE__.$struct$LAYOUT;
    }
    ...
    public static int unused$get(MemorySegment seg) {
        return (int)HINSTANCE__.unused$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void unused$set(MemorySegment seg, int x) {
        HINSTANCE__.unused$VH.set(seg, x);
    }
    public static int unused$get(MemorySegment seg, long index) {
        return (int)HINSTANCE__.unused$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void unused$set(MemorySegment seg, long index, int x) {
        HINSTANCE__.unused$VH.set(seg.asSlice(index*sizeof()), x);
    }
