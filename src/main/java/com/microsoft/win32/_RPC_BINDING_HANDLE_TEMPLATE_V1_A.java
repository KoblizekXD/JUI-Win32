...
public class _RPC_BINDING_HANDLE_TEMPLATE_V1_A {
    ...
    public static MemoryLayout $LAYOUT() {
        return _RPC_BINDING_HANDLE_TEMPLATE_V1_A.$struct$LAYOUT;
    }
    static final VarHandle Version$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("Version"));
    public static VarHandle Version$VH() {
        return _RPC_BINDING_HANDLE_TEMPLATE_V1_A.Version$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int Version$get(MemorySegment seg) {
        return (int)_RPC_BINDING_HANDLE_TEMPLATE_V1_A.Version$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Version$set(MemorySegment seg, int x) {
        _RPC_BINDING_HANDLE_TEMPLATE_V1_A.Version$VH.set(seg, x);
    }
    public static int Version$get(MemorySegment seg, long index) {
        return (int)_RPC_BINDING_HANDLE_TEMPLATE_V1_A.Version$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void Version$set(MemorySegment seg, long index, int x) {
        _RPC_BINDING_HANDLE_TEMPLATE_V1_A.Version$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle Flags$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("Flags"));
    public static VarHandle Flags$VH() {
        return _RPC_BINDING_HANDLE_TEMPLATE_V1_A.Flags$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int Flags$get(MemorySegment seg) {
        return (int)_RPC_BINDING_HANDLE_TEMPLATE_V1_A.Flags$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Flags$set(MemorySegment seg, int x) {
        _RPC_BINDING_HANDLE_TEMPLATE_V1_A.Flags$VH.set(seg, x);
    }
    public static int Flags$get(MemorySegment seg, long index) {
        return (int)_RPC_BINDING_HANDLE_TEMPLATE_V1_A.Flags$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void Flags$set(MemorySegment seg, long index, int x) {
        _RPC_BINDING_HANDLE_TEMPLATE_V1_A.Flags$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle ProtocolSequence$VH() {
        return _RPC_BINDING_HANDLE_TEMPLATE_V1_A.ProtocolSequence$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int ProtocolSequence$get(MemorySegment seg) {
        return (int)_RPC_BINDING_HANDLE_TEMPLATE_V1_A.ProtocolSequence$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void ProtocolSequence$set(MemorySegment seg, int x) {
        _RPC_BINDING_HANDLE_TEMPLATE_V1_A.ProtocolSequence$VH.set(seg, x);
    }
    public static int ProtocolSequence$get(MemorySegment seg, long index) {
        return (int)_RPC_BINDING_HANDLE_TEMPLATE_V1_A.ProtocolSequence$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ProtocolSequence$set(MemorySegment seg, long index, int x) {
        _RPC_BINDING_HANDLE_TEMPLATE_V1_A.ProtocolSequence$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle NetworkAddress$VH() {
        return _RPC_BINDING_HANDLE_TEMPLATE_V1_A.NetworkAddress$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment NetworkAddress$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_RPC_BINDING_HANDLE_TEMPLATE_V1_A.NetworkAddress$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void NetworkAddress$set(MemorySegment seg, MemorySegment x) {
        _RPC_BINDING_HANDLE_TEMPLATE_V1_A.NetworkAddress$VH.set(seg, x);
    }
    public static MemorySegment NetworkAddress$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_RPC_BINDING_HANDLE_TEMPLATE_V1_A.NetworkAddress$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void NetworkAddress$set(MemorySegment seg, long index, MemorySegment x) {
        _RPC_BINDING_HANDLE_TEMPLATE_V1_A.NetworkAddress$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle StringEndpoint$VH() {
        return _RPC_BINDING_HANDLE_TEMPLATE_V1_A.StringEndpoint$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment StringEndpoint$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_RPC_BINDING_HANDLE_TEMPLATE_V1_A.StringEndpoint$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void StringEndpoint$set(MemorySegment seg, MemorySegment x) {
        _RPC_BINDING_HANDLE_TEMPLATE_V1_A.StringEndpoint$VH.set(seg, x);
    }
    public static MemorySegment StringEndpoint$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_RPC_BINDING_HANDLE_TEMPLATE_V1_A.StringEndpoint$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void StringEndpoint$set(MemorySegment seg, long index, MemorySegment x) {
        _RPC_BINDING_HANDLE_TEMPLATE_V1_A.StringEndpoint$VH.set(seg.asSlice(index*sizeof()), x);
    }
    /**
     * {@snippet :
     * union {
