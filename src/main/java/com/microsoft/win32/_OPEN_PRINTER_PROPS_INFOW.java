...
public class _OPEN_PRINTER_PROPS_INFOW {
    ...
    public static MemorySegment pszSheetName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_OPEN_PRINTER_PROPS_INFOW.pszSheetName$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pszSheetName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_OPEN_PRINTER_PROPS_INFOW.pszSheetName$VH.get(seg.asSlice(index*sizeof()));
    }
