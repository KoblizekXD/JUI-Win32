...
public class _PRINTER_INFO_9A {
    ...
    public static MemorySegment pDevMode$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_PRINTER_INFO_9A.pDevMode$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pDevMode$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_PRINTER_INFO_9A.pDevMode$VH.get(seg.asSlice(index*sizeof()));
    }
