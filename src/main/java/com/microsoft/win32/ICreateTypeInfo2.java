...
public class ICreateTypeInfo2 {
    ...
    public static MemoryLayout $LAYOUT() {
        return ICreateTypeInfo2.$struct$LAYOUT;
    }
    ...
    public static VarHandle lpVtbl$VH() {
        return ICreateTypeInfo2.lpVtbl$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)ICreateTypeInfo2.lpVtbl$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpVtbl$set(MemorySegment seg, MemorySegment x) {
        ICreateTypeInfo2.lpVtbl$VH.set(seg, x);
    }
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)ICreateTypeInfo2.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpVtbl$set(MemorySegment seg, long index, MemorySegment x) {
        ICreateTypeInfo2.lpVtbl$VH.set(seg.asSlice(index*sizeof()), x);
    }
