...
public class _CERT_X942_DH_PARAMETERS {
    ...
    public static MemorySegment pValidationParams$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CERT_X942_DH_PARAMETERS.pValidationParams$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pValidationParams$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CERT_X942_DH_PARAMETERS.pValidationParams$VH.get(seg.asSlice(index*sizeof()));
    }
