...
public class _QUERY_SERVICE_LOCK_STATUSA {
    ...
    public static MemorySegment lpLockOwner$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_QUERY_SERVICE_LOCK_STATUSA.lpLockOwner$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpLockOwner$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_QUERY_SERVICE_LOCK_STATUSA.lpLockOwner$VH.get(seg.asSlice(index*sizeof()));
    }
