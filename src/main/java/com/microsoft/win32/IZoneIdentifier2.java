...
public class IZoneIdentifier2 {
    ...
    public static MemoryLayout $LAYOUT() {
        return IZoneIdentifier2.$struct$LAYOUT;
    }
    ...
    public static VarHandle lpVtbl$VH() {
        return IZoneIdentifier2.lpVtbl$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)IZoneIdentifier2.lpVtbl$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpVtbl$set(MemorySegment seg, MemorySegment x) {
        IZoneIdentifier2.lpVtbl$VH.set(seg, x);
    }
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)IZoneIdentifier2.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpVtbl$set(MemorySegment seg, long index, MemorySegment x) {
        IZoneIdentifier2.lpVtbl$VH.set(seg.asSlice(index*sizeof()), x);
    }
