...
public class _CRYPT_ATTRIBUTE {
    ...
    public static MemorySegment pszObjId$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CRYPT_ATTRIBUTE.pszObjId$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pszObjId$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CRYPT_ATTRIBUTE.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment rgValue$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CRYPT_ATTRIBUTE.rgValue$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment rgValue$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CRYPT_ATTRIBUTE.rgValue$VH.get(seg.asSlice(index*sizeof()));
    }
