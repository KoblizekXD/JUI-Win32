...
public class tagCOMPAREITEMSTRUCT {
    ...
    public static MemorySegment hwndItem$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagCOMPAREITEMSTRUCT.hwndItem$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment hwndItem$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagCOMPAREITEMSTRUCT.hwndItem$VH.get(seg.asSlice(index*sizeof()));
    }
