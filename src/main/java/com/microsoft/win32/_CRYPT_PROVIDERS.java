...
public class _CRYPT_PROVIDERS {
    ...
    public static MemorySegment rgpszProviders$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CRYPT_PROVIDERS.rgpszProviders$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment rgpszProviders$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CRYPT_PROVIDERS.rgpszProviders$VH.get(seg.asSlice(index*sizeof()));
    }
