...
public class SC_HANDLE__ {
    ...
    public static MemoryLayout $LAYOUT() {
        return SC_HANDLE__.$struct$LAYOUT;
    }
    ...
    public static int unused$get(MemorySegment seg) {
        return (int)SC_HANDLE__.unused$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void unused$set(MemorySegment seg, int x) {
        SC_HANDLE__.unused$VH.set(seg, x);
    }
    public static int unused$get(MemorySegment seg, long index) {
        return (int)SC_HANDLE__.unused$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void unused$set(MemorySegment seg, long index, int x) {
        SC_HANDLE__.unused$VH.set(seg.asSlice(index*sizeof()), x);
    }
