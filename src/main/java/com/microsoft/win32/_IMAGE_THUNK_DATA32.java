...
public class _IMAGE_THUNK_DATA32 {
    ...
    static final StructLayout $struct$LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            Constants$root.C_LONG$LAYOUT.withName("ForwarderString"),
            Constants$root.C_LONG$LAYOUT.withName("Function"),
            Constants$root.C_LONG$LAYOUT.withName("Ordinal"),
            Constants$root.C_LONG$LAYOUT.withName("AddressOfData")
        ).withName("u1")
