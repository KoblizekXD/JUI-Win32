...
final class constants$322 {
    ...
    static final MethodHandle InitializeContext$MH = RuntimeHelper.downcallHandle(
        "InitializeContext",
        constants$322.InitializeContext$FUNC
    );
    ...
    static final MethodHandle InitializeContext2$MH = RuntimeHelper.downcallHandle(
        "InitializeContext2",
        constants$322.InitializeContext2$FUNC
    );
    ...
    static final MethodHandle GetEnabledXStateFeatures$MH = RuntimeHelper.downcallHandle(
        ...
        constants$322.GetEnabledXStateFeatures$FUNC
    );
    ...
    static final MethodHandle GetXStateFeaturesMask$MH = RuntimeHelper.downcallHandle(
        ...
        constants$322.GetXStateFeaturesMask$FUNC
    );
    ...
    static final MethodHandle LocateXStateFeature$MH = RuntimeHelper.downcallHandle(
        "LocateXStateFeature",
        constants$322.LocateXStateFeature$FUNC
    );
    ...
    static final MethodHandle SetXStateFeaturesMask$MH = RuntimeHelper.downcallHandle(
        ...
        constants$322.SetXStateFeaturesMask$FUNC
    );
}
