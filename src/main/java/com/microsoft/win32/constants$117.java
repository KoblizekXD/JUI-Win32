...
final class constants$117 {
    ...
    static final MethodHandle CompareFileTime$MH = RuntimeHelper.downcallHandle(
        "CompareFileTime",
        constants$117.CompareFileTime$FUNC
    );
    ...
    static final MethodHandle CreateDirectoryA$MH = RuntimeHelper.downcallHandle(
        "CreateDirectoryA",
        constants$117.CreateDirectoryA$FUNC
    );
    ...
    static final MethodHandle CreateDirectoryW$MH = RuntimeHelper.downcallHandle(
        "CreateDirectoryW",
        constants$117.CreateDirectoryW$FUNC
    );
    ...
    static final MethodHandle CreateFileA$MH = RuntimeHelper.downcallHandle(
        "CreateFileA",
        constants$117.CreateFileA$FUNC
    );
    ...
    static final MethodHandle CreateFileW$MH = RuntimeHelper.downcallHandle(
        "CreateFileW",
        constants$117.CreateFileW$FUNC
    );
    ...
    static final MethodHandle DefineDosDeviceW$MH = RuntimeHelper.downcallHandle(
        "DefineDosDeviceW",
        constants$117.DefineDosDeviceW$FUNC
    );
}
