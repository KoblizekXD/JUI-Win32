...
final class constants$318 {
    ...
    static final MethodHandle GetNumaAvailableMemoryNode$MH = RuntimeHelper.downcallHandle(
        ...
        constants$318.GetNumaAvailableMemoryNode$FUNC
    );
    ...
    static final MethodHandle GetNumaAvailableMemoryNodeEx$MH = RuntimeHelper.downcallHandle(
        ...
        constants$318.GetNumaAvailableMemoryNodeEx$FUNC
    );
    ...
    static final MethodHandle GetNumaProximityNode$MH = RuntimeHelper.downcallHandle(
        ...
        constants$318.GetNumaProximityNode$FUNC
    );
    static final FunctionDescriptor APPLICATION_RECOVERY_CALLBACK$FUNC = FunctionDescriptor.of(Constants$root.C_LONG$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    static final FunctionDescriptor APPLICATION_RECOVERY_CALLBACK_UP$FUNC = FunctionDescriptor.of(Constants$root.C_LONG$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle APPLICATION_RECOVERY_CALLBACK_UP$MH = RuntimeHelper.upcallHandle(APPLICATION_RECOVERY_CALLBACK.class, "apply", constants$318.APPLICATION_RECOVERY_CALLBACK_UP$FUNC);
    static final FunctionDescriptor APPLICATION_RECOVERY_CALLBACK_DOWN$FUNC = FunctionDescriptor.of(Constants$root.C_LONG$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle APPLICATION_RECOVERY_CALLBACK_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$318.APPLICATION_RECOVERY_CALLBACK_DOWN$FUNC
    );
    ...
    static final MethodHandle RegisterApplicationRecoveryCallback$MH = RuntimeHelper.downcallHandle(
        ...
        constants$318.RegisterApplicationRecoveryCallback$FUNC
    );
}
