...
public interface PROPENUMPROCEX {
    ...
    static MemorySegment allocate(PROPENUMPROCEX fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$394.PROPENUMPROCEX_UP$MH, fi, constants$394.PROPENUMPROCEX$FUNC, scope);
    }
    static PROPENUMPROCEX ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment __x0, java.lang.foreign.MemorySegment __x1, java.lang.foreign.MemorySegment __x2, long __x3) -> {
            try {
                return (int)constants$394.PROPENUMPROCEX_DOWN$MH.invokeExact(symbol, __x0, __x1, __x2, __x3);
            } catch (Throwable ex$) {
