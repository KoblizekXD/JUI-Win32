...
public class _ADDJOB_INFO_1W {
    ...
    public static MemorySegment Path$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_ADDJOB_INFO_1W.Path$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment Path$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_ADDJOB_INFO_1W.Path$VH.get(seg.asSlice(index*sizeof()));
    }
