...
public class _CREATE_THREAD_DEBUG_INFO {
    ...
    public static MemorySegment hThread$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CREATE_THREAD_DEBUG_INFO.hThread$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment hThread$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CREATE_THREAD_DEBUG_INFO.hThread$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment lpThreadLocalBase$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CREATE_THREAD_DEBUG_INFO.lpThreadLocalBase$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpThreadLocalBase$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CREATE_THREAD_DEBUG_INFO.lpThreadLocalBase$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment lpStartAddress$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CREATE_THREAD_DEBUG_INFO.lpStartAddress$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpStartAddress$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CREATE_THREAD_DEBUG_INFO.lpStartAddress$VH.get(seg.asSlice(index*sizeof()));
    }
