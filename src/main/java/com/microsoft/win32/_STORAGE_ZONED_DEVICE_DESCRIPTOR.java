...
public class _STORAGE_ZONED_DEVICE_DESCRIPTOR {
    ...
    public static final class ZoneAttributes {
        ...
        static final UnionLayout ZoneAttributes$union$LAYOUT = MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                Constants$root.C_LONG$LAYOUT.withName("MaxOpenZoneCount"),
                Constants$root.C_CHAR$LAYOUT.withName("UnrestrictedRead"),
                MemoryLayout.sequenceLayout(3, Constants$root.C_CHAR$LAYOUT).withName("Reserved")
        ...
        public static final class SequentialRequiredZone {
            ...
            static final StructLayout ZoneAttributes$SequentialRequiredZone$struct$LAYOUT = MemoryLayout.structLayout(
                Constants$root.C_LONG$LAYOUT.withName("MaxOpenZoneCount"),
                Constants$root.C_CHAR$LAYOUT.withName("UnrestrictedRead"),
                MemoryLayout.sequenceLayout(3, Constants$root.C_CHAR$LAYOUT).withName("Reserved")
            );
        ...
        public static final class SequentialPreferredZone {
            ...
            static final StructLayout ZoneAttributes$SequentialPreferredZone$struct$LAYOUT = MemoryLayout.structLayout(
                Constants$root.C_LONG$LAYOUT.withName("OptimalOpenZoneCount"),
                Constants$root.C_LONG$LAYOUT.withName("Reserved")
            );
            public static MemoryLayout $LAYOUT() {
