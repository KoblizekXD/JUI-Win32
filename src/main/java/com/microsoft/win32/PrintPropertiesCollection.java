...
public class PrintPropertiesCollection {
    ...
    public static MemorySegment propertiesCollection$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)PrintPropertiesCollection.propertiesCollection$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment propertiesCollection$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)PrintPropertiesCollection.propertiesCollection$VH.get(seg.asSlice(index*sizeof()));
    }
