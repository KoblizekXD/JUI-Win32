...
public class IRpcSyntaxNegotiate {
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)IRpcSyntaxNegotiate.lpVtbl$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)IRpcSyntaxNegotiate.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
