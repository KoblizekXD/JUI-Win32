...
public class _EFS_HASH_BLOB {
    ...
    public static MemorySegment pbData$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_EFS_HASH_BLOB.pbData$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pbData$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_EFS_HASH_BLOB.pbData$VH.get(seg.asSlice(index*sizeof()));
    }
