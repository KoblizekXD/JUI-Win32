...
public class _SINGLE_LIST_ENTRY {
    ...
    public static MemorySegment Next$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_SINGLE_LIST_ENTRY.Next$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment Next$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_SINGLE_LIST_ENTRY.Next$VH.get(seg.asSlice(index*sizeof()));
    }
