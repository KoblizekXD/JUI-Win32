...
public class _NOTIFYICONIDENTIFIER {
    ...
    public static MemorySegment hWnd$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_NOTIFYICONIDENTIFIER.hWnd$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment hWnd$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_NOTIFYICONIDENTIFIER.hWnd$VH.get(seg.asSlice(index*sizeof()));
    }
