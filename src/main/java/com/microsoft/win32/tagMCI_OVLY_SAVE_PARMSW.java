...
public class tagMCI_OVLY_SAVE_PARMSW {
    ...
    public static MemoryLayout $LAYOUT() {
        return tagMCI_OVLY_SAVE_PARMSW.$struct$LAYOUT;
    }
    ...
    public static VarHandle dwCallback$VH() {
        return tagMCI_OVLY_SAVE_PARMSW.dwCallback$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long dwCallback$get(MemorySegment seg) {
        return (long)tagMCI_OVLY_SAVE_PARMSW.dwCallback$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwCallback$set(MemorySegment seg, long x) {
        tagMCI_OVLY_SAVE_PARMSW.dwCallback$VH.set(seg, x);
    }
    public static long dwCallback$get(MemorySegment seg, long index) {
        return (long)tagMCI_OVLY_SAVE_PARMSW.dwCallback$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwCallback$set(MemorySegment seg, long index, long x) {
        tagMCI_OVLY_SAVE_PARMSW.dwCallback$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle lpfilename$VH() {
        return tagMCI_OVLY_SAVE_PARMSW.lpfilename$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpfilename$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagMCI_OVLY_SAVE_PARMSW.lpfilename$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpfilename$set(MemorySegment seg, MemorySegment x) {
        tagMCI_OVLY_SAVE_PARMSW.lpfilename$VH.set(seg, x);
    }
    public static MemorySegment lpfilename$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagMCI_OVLY_SAVE_PARMSW.lpfilename$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpfilename$set(MemorySegment seg, long index, MemorySegment x) {
        tagMCI_OVLY_SAVE_PARMSW.lpfilename$VH.set(seg.asSlice(index*sizeof()), x);
    }
