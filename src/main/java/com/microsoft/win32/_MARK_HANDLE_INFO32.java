...
public class _MARK_HANDLE_INFO32 {
    ...
    public static MemoryLayout $LAYOUT() {
        return _MARK_HANDLE_INFO32.$struct$LAYOUT;
    }
    ...
    public static VarHandle UsnSourceInfo$VH() {
        return _MARK_HANDLE_INFO32.UsnSourceInfo$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int UsnSourceInfo$get(MemorySegment seg) {
        return (int)_MARK_HANDLE_INFO32.UsnSourceInfo$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void UsnSourceInfo$set(MemorySegment seg, int x) {
        _MARK_HANDLE_INFO32.UsnSourceInfo$VH.set(seg, x);
    }
    public static int UsnSourceInfo$get(MemorySegment seg, long index) {
        return (int)_MARK_HANDLE_INFO32.UsnSourceInfo$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void UsnSourceInfo$set(MemorySegment seg, long index, int x) {
        _MARK_HANDLE_INFO32.UsnSourceInfo$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle CopyNumber$VH() {
        return _MARK_HANDLE_INFO32.CopyNumber$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int CopyNumber$get(MemorySegment seg) {
        return (int)_MARK_HANDLE_INFO32.CopyNumber$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void CopyNumber$set(MemorySegment seg, int x) {
        _MARK_HANDLE_INFO32.CopyNumber$VH.set(seg, x);
    }
    public static int CopyNumber$get(MemorySegment seg, long index) {
        return (int)_MARK_HANDLE_INFO32.CopyNumber$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void CopyNumber$set(MemorySegment seg, long index, int x) {
        _MARK_HANDLE_INFO32.CopyNumber$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle VolumeHandle$VH() {
        return _MARK_HANDLE_INFO32.VolumeHandle$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int VolumeHandle$get(MemorySegment seg) {
        return (int)_MARK_HANDLE_INFO32.VolumeHandle$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void VolumeHandle$set(MemorySegment seg, int x) {
        _MARK_HANDLE_INFO32.VolumeHandle$VH.set(seg, x);
    }
    public static int VolumeHandle$get(MemorySegment seg, long index) {
        return (int)_MARK_HANDLE_INFO32.VolumeHandle$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void VolumeHandle$set(MemorySegment seg, long index, int x) {
        _MARK_HANDLE_INFO32.VolumeHandle$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle HandleInfo$VH() {
        return _MARK_HANDLE_INFO32.HandleInfo$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int HandleInfo$get(MemorySegment seg) {
        return (int)_MARK_HANDLE_INFO32.HandleInfo$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void HandleInfo$set(MemorySegment seg, int x) {
        _MARK_HANDLE_INFO32.HandleInfo$VH.set(seg, x);
    }
    public static int HandleInfo$get(MemorySegment seg, long index) {
        return (int)_MARK_HANDLE_INFO32.HandleInfo$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void HandleInfo$set(MemorySegment seg, long index, int x) {
        _MARK_HANDLE_INFO32.HandleInfo$VH.set(seg.asSlice(index*sizeof()), x);
    }
