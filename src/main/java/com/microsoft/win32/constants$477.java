...
final class constants$477 {
    ...
    static final MethodHandle GetCaretPos$MH = RuntimeHelper.downcallHandle(
        "GetCaretPos",
        constants$477.GetCaretPos$FUNC
    );
    ...
    static final MethodHandle ClientToScreen$MH = RuntimeHelper.downcallHandle(
        "ClientToScreen",
        constants$477.ClientToScreen$FUNC
    );
    ...
    static final MethodHandle ScreenToClient$MH = RuntimeHelper.downcallHandle(
        "ScreenToClient",
        constants$477.ScreenToClient$FUNC
    );
    ...
    static final MethodHandle LogicalToPhysicalPoint$MH = RuntimeHelper.downcallHandle(
        ...
        constants$477.LogicalToPhysicalPoint$FUNC
    );
    ...
    static final MethodHandle PhysicalToLogicalPoint$MH = RuntimeHelper.downcallHandle(
        ...
        constants$477.PhysicalToLogicalPoint$FUNC
    );
    ...
    static final MethodHandle LogicalToPhysicalPointForPerMonitorDPI$MH = RuntimeHelper.downcallHandle(
        ...
        constants$477.LogicalToPhysicalPointForPerMonitorDPI$FUNC
    );
}
