...
public class _CRYPT_PSOURCE_ALGORITHM {
    ...
    public static MemorySegment pszObjId$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CRYPT_PSOURCE_ALGORITHM.pszObjId$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pszObjId$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CRYPT_PSOURCE_ALGORITHM.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
