...
public class _KTMOBJECT_CURSOR {
    ...
    static final StructLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        Constants$root.C_LONG$LAYOUT.withName("ObjectIdCount"),
    ...
    static final VarHandle ObjectIdCount$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("ObjectIdCount"));
