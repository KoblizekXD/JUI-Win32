...
public class HWAVEOUT__ {
    ...
    public static MemoryLayout $LAYOUT() {
        return HWAVEOUT__.$struct$LAYOUT;
    }
    ...
    public static int unused$get(MemorySegment seg) {
        return (int)HWAVEOUT__.unused$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void unused$set(MemorySegment seg, int x) {
        HWAVEOUT__.unused$VH.set(seg, x);
    }
    public static int unused$get(MemorySegment seg, long index) {
        return (int)HWAVEOUT__.unused$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void unused$set(MemorySegment seg, long index, int x) {
        HWAVEOUT__.unused$VH.set(seg.asSlice(index*sizeof()), x);
    }
