...
final class constants$252 {
    ...
    static final MethodHandle GlobalDeleteAtom$MH = RuntimeHelper.downcallHandle(
        "GlobalDeleteAtom",
        constants$252.GlobalDeleteAtom$FUNC
    );
    ...
    static final MethodHandle InitAtomTable$MH = RuntimeHelper.downcallHandle(
        "InitAtomTable",
        constants$252.InitAtomTable$FUNC
    );
    ...
    static final MethodHandle SetHandleCount$MH = RuntimeHelper.downcallHandle(
        "SetHandleCount",
        constants$252.SetHandleCount$FUNC
    );
    ...
    static final MethodHandle RequestDeviceWakeup$MH = RuntimeHelper.downcallHandle(
        "RequestDeviceWakeup",
        constants$252.RequestDeviceWakeup$FUNC
    );
    ...
    static final MethodHandle CancelDeviceWakeupRequest$MH = RuntimeHelper.downcallHandle(
        ...
        constants$252.CancelDeviceWakeupRequest$FUNC
    );
}
