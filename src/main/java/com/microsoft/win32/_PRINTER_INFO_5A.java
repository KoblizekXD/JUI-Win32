...
public class _PRINTER_INFO_5A {
    ...
    public static MemorySegment pPrinterName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_PRINTER_INFO_5A.pPrinterName$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pPrinterName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_PRINTER_INFO_5A.pPrinterName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment pPortName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_PRINTER_INFO_5A.pPortName$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pPortName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_PRINTER_INFO_5A.pPortName$VH.get(seg.asSlice(index*sizeof()));
    }
