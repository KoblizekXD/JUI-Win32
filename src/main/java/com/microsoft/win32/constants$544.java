...
final class constants$544 {
    ...
    static final MethodHandle GetUserDefaultLocaleName$MH = RuntimeHelper.downcallHandle(
        ...
        constants$544.GetUserDefaultLocaleName$FUNC
    );
    ...
    static final MethodHandle GetSystemDefaultLocaleName$MH = RuntimeHelper.downcallHandle(
        ...
        constants$544.GetSystemDefaultLocaleName$FUNC
    );
    ...
    static final MethodHandle IsNLSDefinedString$MH = RuntimeHelper.downcallHandle(
        "IsNLSDefinedString",
        constants$544.IsNLSDefinedString$FUNC
    );
    ...
    static final MethodHandle GetNLSVersionEx$MH = RuntimeHelper.downcallHandle(
        "GetNLSVersionEx",
        constants$544.GetNLSVersionEx$FUNC
    );
    ...
    static final MethodHandle IsValidNLSVersion$MH = RuntimeHelper.downcallHandle(
        "IsValidNLSVersion",
        constants$544.IsValidNLSVersion$FUNC
    );
    ...
    static final MethodHandle FindNLSStringEx$MH = RuntimeHelper.downcallHandle(
        "FindNLSStringEx",
        constants$544.FindNLSStringEx$FUNC
    );
}
