...
public class _NV_MEMORY_RANGE {
    ...
    public static MemorySegment BaseAddress$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_NV_MEMORY_RANGE.BaseAddress$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment BaseAddress$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_NV_MEMORY_RANGE.BaseAddress$VH.get(seg.asSlice(index*sizeof()));
    }
