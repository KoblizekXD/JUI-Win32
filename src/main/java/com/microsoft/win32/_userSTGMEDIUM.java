...
public class _userSTGMEDIUM {
    ...
    public static MemorySegment pUnkForRelease$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_userSTGMEDIUM.pUnkForRelease$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pUnkForRelease$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_userSTGMEDIUM.pUnkForRelease$VH.get(seg.asSlice(index*sizeof()));
    }
