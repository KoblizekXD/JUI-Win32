...
public class _SHFILEINFOA {
    ...
    public static MemorySegment hIcon$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_SHFILEINFOA.hIcon$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment hIcon$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_SHFILEINFOA.hIcon$VH.get(seg.asSlice(index*sizeof()));
    }
