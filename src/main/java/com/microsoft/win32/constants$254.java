...
final class constants$254 {
    ...
    static final MethodHandle ClearCommBreak$MH = RuntimeHelper.downcallHandle(
        "ClearCommBreak",
        constants$254.ClearCommBreak$FUNC
    );
    ...
    static final MethodHandle ClearCommError$MH = RuntimeHelper.downcallHandle(
        "ClearCommError",
        constants$254.ClearCommError$FUNC
    );
    ...
    static final MethodHandle EscapeCommFunction$MH = RuntimeHelper.downcallHandle(
        "EscapeCommFunction",
        constants$254.EscapeCommFunction$FUNC
    );
    ...
    static final MethodHandle GetCommConfig$MH = RuntimeHelper.downcallHandle(
        "GetCommConfig",
        constants$254.GetCommConfig$FUNC
    );
    ...
    static final MethodHandle GetCommMask$MH = RuntimeHelper.downcallHandle(
        "GetCommMask",
        constants$254.GetCommMask$FUNC
    );
}
