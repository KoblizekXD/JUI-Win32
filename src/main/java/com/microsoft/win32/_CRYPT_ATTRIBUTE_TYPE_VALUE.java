...
public class _CRYPT_ATTRIBUTE_TYPE_VALUE {
    ...
    public static MemorySegment pszObjId$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CRYPT_ATTRIBUTE_TYPE_VALUE.pszObjId$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pszObjId$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CRYPT_ATTRIBUTE_TYPE_VALUE.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
