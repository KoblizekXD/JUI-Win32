...
final class constants$128 {
    ...
    static final MethodHandle SetFileAttributesA$MH = RuntimeHelper.downcallHandle(
        "SetFileAttributesA",
        constants$128.SetFileAttributesA$FUNC
    );
    ...
    static final MethodHandle SetFileAttributesW$MH = RuntimeHelper.downcallHandle(
        "SetFileAttributesW",
        constants$128.SetFileAttributesW$FUNC
    );
    ...
    static final MethodHandle SetFileInformationByHandle$MH = RuntimeHelper.downcallHandle(
        ...
        constants$128.SetFileInformationByHandle$FUNC
    );
    ...
    static final MethodHandle SetFilePointer$MH = RuntimeHelper.downcallHandle(
        "SetFilePointer",
        constants$128.SetFilePointer$FUNC
    );
    ...
    static final MethodHandle SetFilePointerEx$MH = RuntimeHelper.downcallHandle(
        "SetFilePointerEx",
        constants$128.SetFilePointerEx$FUNC
    );
    ...
    static final MethodHandle SetFileTime$MH = RuntimeHelper.downcallHandle(
        "SetFileTime",
        constants$128.SetFileTime$FUNC
    );
}
