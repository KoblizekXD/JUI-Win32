...
public class IWinInetCacheHints2 {
    ...
    public static MemoryLayout $LAYOUT() {
        return IWinInetCacheHints2.$struct$LAYOUT;
    }
    ...
    public static VarHandle lpVtbl$VH() {
        return IWinInetCacheHints2.lpVtbl$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)IWinInetCacheHints2.lpVtbl$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpVtbl$set(MemorySegment seg, MemorySegment x) {
        IWinInetCacheHints2.lpVtbl$VH.set(seg, x);
    }
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)IWinInetCacheHints2.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpVtbl$set(MemorySegment seg, long index, MemorySegment x) {
        IWinInetCacheHints2.lpVtbl$VH.set(seg.asSlice(index*sizeof()), x);
    }
