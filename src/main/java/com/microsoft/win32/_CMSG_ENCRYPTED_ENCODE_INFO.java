...
public class _CMSG_ENCRYPTED_ENCODE_INFO {
    ...
    public static MemorySegment pvEncryptionAuxInfo$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CMSG_ENCRYPTED_ENCODE_INFO.pvEncryptionAuxInfo$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pvEncryptionAuxInfo$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CMSG_ENCRYPTED_ENCODE_INFO.pvEncryptionAuxInfo$VH.get(seg.asSlice(index*sizeof()));
    }
