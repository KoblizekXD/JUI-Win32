...
public class _FILE_STORAGE_TIER {
    ...
    public static MemoryLayout $LAYOUT() {
        return _FILE_STORAGE_TIER.$struct$LAYOUT;
    }
    ...
    public static VarHandle Flags$VH() {
        return _FILE_STORAGE_TIER.Flags$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long Flags$get(MemorySegment seg) {
        return (long)_FILE_STORAGE_TIER.Flags$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Flags$set(MemorySegment seg, long x) {
        _FILE_STORAGE_TIER.Flags$VH.set(seg, x);
    }
    public static long Flags$get(MemorySegment seg, long index) {
        return (long)_FILE_STORAGE_TIER.Flags$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void Flags$set(MemorySegment seg, long index, long x) {
        _FILE_STORAGE_TIER.Flags$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle ProvisionedCapacity$VH() {
        return _FILE_STORAGE_TIER.ProvisionedCapacity$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long ProvisionedCapacity$get(MemorySegment seg) {
        return (long)_FILE_STORAGE_TIER.ProvisionedCapacity$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void ProvisionedCapacity$set(MemorySegment seg, long x) {
        _FILE_STORAGE_TIER.ProvisionedCapacity$VH.set(seg, x);
    }
    public static long ProvisionedCapacity$get(MemorySegment seg, long index) {
        return (long)_FILE_STORAGE_TIER.ProvisionedCapacity$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ProvisionedCapacity$set(MemorySegment seg, long index, long x) {
        _FILE_STORAGE_TIER.ProvisionedCapacity$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle MediaType$VH() {
        return _FILE_STORAGE_TIER.MediaType$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int MediaType$get(MemorySegment seg) {
        return (int)_FILE_STORAGE_TIER.MediaType$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void MediaType$set(MemorySegment seg, int x) {
        _FILE_STORAGE_TIER.MediaType$VH.set(seg, x);
    }
    public static int MediaType$get(MemorySegment seg, long index) {
        return (int)_FILE_STORAGE_TIER.MediaType$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void MediaType$set(MemorySegment seg, long index, int x) {
        _FILE_STORAGE_TIER.MediaType$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle Class$VH() {
        return _FILE_STORAGE_TIER.Class$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int Class$get(MemorySegment seg) {
        return (int)_FILE_STORAGE_TIER.Class$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Class$set(MemorySegment seg, int x) {
        _FILE_STORAGE_TIER.Class$VH.set(seg, x);
    }
    public static int Class$get(MemorySegment seg, long index) {
        return (int)_FILE_STORAGE_TIER.Class$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void Class$set(MemorySegment seg, long index, int x) {
        _FILE_STORAGE_TIER.Class$VH.set(seg.asSlice(index*sizeof()), x);
    }
