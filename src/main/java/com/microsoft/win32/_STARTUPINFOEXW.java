...
public class _STARTUPINFOEXW {
    ...
    public static MemorySegment lpAttributeList$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_STARTUPINFOEXW.lpAttributeList$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpAttributeList$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_STARTUPINFOEXW.lpAttributeList$VH.get(seg.asSlice(index*sizeof()));
    }
