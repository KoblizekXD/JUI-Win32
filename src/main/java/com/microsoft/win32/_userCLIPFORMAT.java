...
public class _userCLIPFORMAT {
    ...
    public static final class __MIDL_IWinTypes_0001 {
        ...
        static final UnionLayout __MIDL_IWinTypes_0001$union$LAYOUT = MemoryLayout.unionLayout(
            Constants$root.C_LONG$LAYOUT.withName("dwValue"),
            Constants$root.C_POINTER$LAYOUT.withName("pwszName")
        ...
        public static MemorySegment pwszName$get(MemorySegment seg) {
            return (java.lang.foreign.MemorySegment)__MIDL_IWinTypes_0001.pwszName$VH.get(seg);
        }
        /**
         * Setter for field:
         * {@snippet :
        ...
        public static MemorySegment pwszName$get(MemorySegment seg, long index) {
            return (java.lang.foreign.MemorySegment)__MIDL_IWinTypes_0001.pwszName$VH.get(seg.asSlice(index*sizeof()));
        }
