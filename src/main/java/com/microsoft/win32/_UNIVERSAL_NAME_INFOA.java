...
public class _UNIVERSAL_NAME_INFOA {
    ...
    public static MemorySegment lpUniversalName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_UNIVERSAL_NAME_INFOA.lpUniversalName$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpUniversalName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_UNIVERSAL_NAME_INFOA.lpUniversalName$VH.get(seg.asSlice(index*sizeof()));
    }
