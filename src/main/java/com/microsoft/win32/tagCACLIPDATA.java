...
public class tagCACLIPDATA {
    ...
    public static MemoryLayout $LAYOUT() {
        return tagCACLIPDATA.$struct$LAYOUT;
    }
    ...
    public static VarHandle cElems$VH() {
        return tagCACLIPDATA.cElems$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int cElems$get(MemorySegment seg) {
        return (int)tagCACLIPDATA.cElems$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cElems$set(MemorySegment seg, int x) {
        tagCACLIPDATA.cElems$VH.set(seg, x);
    }
    public static int cElems$get(MemorySegment seg, long index) {
        return (int)tagCACLIPDATA.cElems$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void cElems$set(MemorySegment seg, long index, int x) {
        tagCACLIPDATA.cElems$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle pElems$VH() {
        return tagCACLIPDATA.pElems$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pElems$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagCACLIPDATA.pElems$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pElems$set(MemorySegment seg, MemorySegment x) {
        tagCACLIPDATA.pElems$VH.set(seg, x);
    }
    public static MemorySegment pElems$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagCACLIPDATA.pElems$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pElems$set(MemorySegment seg, long index, MemorySegment x) {
        tagCACLIPDATA.pElems$VH.set(seg.asSlice(index*sizeof()), x);
    }
