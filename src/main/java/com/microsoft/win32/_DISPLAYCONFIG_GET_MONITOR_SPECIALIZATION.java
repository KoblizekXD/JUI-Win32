...
public class _DISPLAYCONFIG_GET_MONITOR_SPECIALIZATION {
    ...
    public static MemoryLayout $LAYOUT() {
        return _DISPLAYCONFIG_GET_MONITOR_SPECIALIZATION.$struct$LAYOUT;
    }
    ...
    public static VarHandle value$VH() {
        return _DISPLAYCONFIG_GET_MONITOR_SPECIALIZATION.value$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int value$get(MemorySegment seg) {
        return (int)_DISPLAYCONFIG_GET_MONITOR_SPECIALIZATION.value$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void value$set(MemorySegment seg, int x) {
        _DISPLAYCONFIG_GET_MONITOR_SPECIALIZATION.value$VH.set(seg, x);
    }
    public static int value$get(MemorySegment seg, long index) {
        return (int)_DISPLAYCONFIG_GET_MONITOR_SPECIALIZATION.value$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void value$set(MemorySegment seg, long index, int x) {
        _DISPLAYCONFIG_GET_MONITOR_SPECIALIZATION.value$VH.set(seg.asSlice(index*sizeof()), x);
    }
