...
public class tagTYPEATTR {
    ...
    public static MemorySegment lpstrSchema$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagTYPEATTR.lpstrSchema$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpstrSchema$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagTYPEATTR.lpstrSchema$VH.get(seg.asSlice(index*sizeof()));
    }
