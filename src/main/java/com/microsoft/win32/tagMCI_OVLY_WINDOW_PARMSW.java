...
public class tagMCI_OVLY_WINDOW_PARMSW {
    ...
    public static MemorySegment hWnd$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagMCI_OVLY_WINDOW_PARMSW.hWnd$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment hWnd$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagMCI_OVLY_WINDOW_PARMSW.hWnd$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment lpstrText$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagMCI_OVLY_WINDOW_PARMSW.lpstrText$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpstrText$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagMCI_OVLY_WINDOW_PARMSW.lpstrText$VH.get(seg.asSlice(index*sizeof()));
    }
