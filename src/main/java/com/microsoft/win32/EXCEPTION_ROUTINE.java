...
public interface EXCEPTION_ROUTINE {
    ...
    static MemorySegment allocate(EXCEPTION_ROUTINE fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$39.EXCEPTION_ROUTINE_UP$MH, fi, constants$39.EXCEPTION_ROUTINE$FUNC, scope);
    }
    static EXCEPTION_ROUTINE ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _ExceptionRecord, java.lang.foreign.MemorySegment _EstablisherFrame, java.lang.foreign.MemorySegment _ContextRecord, java.lang.foreign.MemorySegment _DispatcherContext) -> {
            try {
                return (int)constants$39.EXCEPTION_ROUTINE_DOWN$MH.invokeExact(symbol, _ExceptionRecord, _EstablisherFrame, _ContextRecord, _DispatcherContext);
            } catch (Throwable ex$) {
