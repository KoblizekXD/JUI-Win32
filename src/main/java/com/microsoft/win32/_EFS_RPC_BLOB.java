...
public class _EFS_RPC_BLOB {
    ...
    public static MemoryLayout $LAYOUT() {
        return _EFS_RPC_BLOB.$struct$LAYOUT;
    }
    ...
    public static VarHandle cbData$VH() {
        return _EFS_RPC_BLOB.cbData$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int cbData$get(MemorySegment seg) {
        return (int)_EFS_RPC_BLOB.cbData$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cbData$set(MemorySegment seg, int x) {
        _EFS_RPC_BLOB.cbData$VH.set(seg, x);
    }
    public static int cbData$get(MemorySegment seg, long index) {
        return (int)_EFS_RPC_BLOB.cbData$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void cbData$set(MemorySegment seg, long index, int x) {
        _EFS_RPC_BLOB.cbData$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle pbData$VH() {
        return _EFS_RPC_BLOB.pbData$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pbData$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_EFS_RPC_BLOB.pbData$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pbData$set(MemorySegment seg, MemorySegment x) {
        _EFS_RPC_BLOB.pbData$VH.set(seg, x);
    }
    public static MemorySegment pbData$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_EFS_RPC_BLOB.pbData$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pbData$set(MemorySegment seg, long index, MemorySegment x) {
        _EFS_RPC_BLOB.pbData$VH.set(seg.asSlice(index*sizeof()), x);
    }
