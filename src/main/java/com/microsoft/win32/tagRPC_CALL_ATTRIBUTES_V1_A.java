...
public class tagRPC_CALL_ATTRIBUTES_V1_A {
    ...
    public static MemorySegment ServerPrincipalName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagRPC_CALL_ATTRIBUTES_V1_A.ServerPrincipalName$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment ServerPrincipalName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagRPC_CALL_ATTRIBUTES_V1_A.ServerPrincipalName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment ClientPrincipalName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagRPC_CALL_ATTRIBUTES_V1_A.ClientPrincipalName$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment ClientPrincipalName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagRPC_CALL_ATTRIBUTES_V1_A.ClientPrincipalName$VH.get(seg.asSlice(index*sizeof()));
    }
