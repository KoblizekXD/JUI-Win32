...
public class value_entA {
    ...
    public static MemoryLayout $LAYOUT() {
        return value_entA.$struct$LAYOUT;
    }
    ...
    public static VarHandle ve_valuename$VH() {
        return value_entA.ve_valuename$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment ve_valuename$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)value_entA.ve_valuename$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void ve_valuename$set(MemorySegment seg, MemorySegment x) {
        value_entA.ve_valuename$VH.set(seg, x);
    }
    public static MemorySegment ve_valuename$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)value_entA.ve_valuename$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ve_valuename$set(MemorySegment seg, long index, MemorySegment x) {
        value_entA.ve_valuename$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle ve_valuelen$VH() {
        return value_entA.ve_valuelen$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int ve_valuelen$get(MemorySegment seg) {
        return (int)value_entA.ve_valuelen$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void ve_valuelen$set(MemorySegment seg, int x) {
        value_entA.ve_valuelen$VH.set(seg, x);
    }
    public static int ve_valuelen$get(MemorySegment seg, long index) {
        return (int)value_entA.ve_valuelen$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ve_valuelen$set(MemorySegment seg, long index, int x) {
        value_entA.ve_valuelen$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle ve_valueptr$VH() {
        return value_entA.ve_valueptr$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long ve_valueptr$get(MemorySegment seg) {
        return (long)value_entA.ve_valueptr$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void ve_valueptr$set(MemorySegment seg, long x) {
        value_entA.ve_valueptr$VH.set(seg, x);
    }
    public static long ve_valueptr$get(MemorySegment seg, long index) {
        return (long)value_entA.ve_valueptr$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ve_valueptr$set(MemorySegment seg, long index, long x) {
        value_entA.ve_valueptr$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int ve_type$get(MemorySegment seg) {
        return (int)value_entA.ve_type$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void ve_type$set(MemorySegment seg, int x) {
        value_entA.ve_type$VH.set(seg, x);
    }
    public static int ve_type$get(MemorySegment seg, long index) {
        return (int)value_entA.ve_type$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void ve_type$set(MemorySegment seg, long index, int x) {
        value_entA.ve_type$VH.set(seg.asSlice(index*sizeof()), x);
    }
