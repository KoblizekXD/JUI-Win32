...
public class _CRYPT_X942_OTHER_INFO {
    ...
    public static MemorySegment pszContentEncryptionObjId$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CRYPT_X942_OTHER_INFO.pszContentEncryptionObjId$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pszContentEncryptionObjId$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CRYPT_X942_OTHER_INFO.pszContentEncryptionObjId$VH.get(seg.asSlice(index*sizeof()));
    }
