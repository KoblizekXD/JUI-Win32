...
public class _HTTPSPolicyCallbackData {
    ...
    public static MemorySegment pwszServerName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_HTTPSPolicyCallbackData.pwszServerName$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pwszServerName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_HTTPSPolicyCallbackData.pwszServerName$VH.get(seg.asSlice(index*sizeof()));
    }
