...
public class _CMSG_CTRL_DECRYPT_PARA {
    ...
    public static MemoryLayout $LAYOUT() {
        return _CMSG_CTRL_DECRYPT_PARA.$struct$LAYOUT;
    }
    static final VarHandle cbSize$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("cbSize"));
    public static VarHandle cbSize$VH() {
        return _CMSG_CTRL_DECRYPT_PARA.cbSize$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int cbSize$get(MemorySegment seg) {
        return (int)_CMSG_CTRL_DECRYPT_PARA.cbSize$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cbSize$set(MemorySegment seg, int x) {
        _CMSG_CTRL_DECRYPT_PARA.cbSize$VH.set(seg, x);
    }
    public static int cbSize$get(MemorySegment seg, long index) {
        return (int)_CMSG_CTRL_DECRYPT_PARA.cbSize$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void cbSize$set(MemorySegment seg, long index, int x) {
        _CMSG_CTRL_DECRYPT_PARA.cbSize$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle hCryptProv$VH() {
        return _CMSG_CTRL_DECRYPT_PARA.hCryptProv$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long hCryptProv$get(MemorySegment seg) {
        return (long)_CMSG_CTRL_DECRYPT_PARA.hCryptProv$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void hCryptProv$set(MemorySegment seg, long x) {
        _CMSG_CTRL_DECRYPT_PARA.hCryptProv$VH.set(seg, x);
    }
    public static long hCryptProv$get(MemorySegment seg, long index) {
        return (long)_CMSG_CTRL_DECRYPT_PARA.hCryptProv$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void hCryptProv$set(MemorySegment seg, long index, long x) {
        _CMSG_CTRL_DECRYPT_PARA.hCryptProv$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle hNCryptKey$VH() {
        return _CMSG_CTRL_DECRYPT_PARA.hNCryptKey$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long hNCryptKey$get(MemorySegment seg) {
        return (long)_CMSG_CTRL_DECRYPT_PARA.hNCryptKey$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void hNCryptKey$set(MemorySegment seg, long x) {
        _CMSG_CTRL_DECRYPT_PARA.hNCryptKey$VH.set(seg, x);
    }
    public static long hNCryptKey$get(MemorySegment seg, long index) {
        return (long)_CMSG_CTRL_DECRYPT_PARA.hNCryptKey$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void hNCryptKey$set(MemorySegment seg, long index, long x) {
        _CMSG_CTRL_DECRYPT_PARA.hNCryptKey$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwKeySpec$VH() {
        return _CMSG_CTRL_DECRYPT_PARA.dwKeySpec$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwKeySpec$get(MemorySegment seg) {
        return (int)_CMSG_CTRL_DECRYPT_PARA.dwKeySpec$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwKeySpec$set(MemorySegment seg, int x) {
        _CMSG_CTRL_DECRYPT_PARA.dwKeySpec$VH.set(seg, x);
    }
    public static int dwKeySpec$get(MemorySegment seg, long index) {
        return (int)_CMSG_CTRL_DECRYPT_PARA.dwKeySpec$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwKeySpec$set(MemorySegment seg, long index, int x) {
        _CMSG_CTRL_DECRYPT_PARA.dwKeySpec$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle dwRecipientIndex$VH() {
        return _CMSG_CTRL_DECRYPT_PARA.dwRecipientIndex$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwRecipientIndex$get(MemorySegment seg) {
        return (int)_CMSG_CTRL_DECRYPT_PARA.dwRecipientIndex$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwRecipientIndex$set(MemorySegment seg, int x) {
        _CMSG_CTRL_DECRYPT_PARA.dwRecipientIndex$VH.set(seg, x);
    }
    public static int dwRecipientIndex$get(MemorySegment seg, long index) {
        return (int)_CMSG_CTRL_DECRYPT_PARA.dwRecipientIndex$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dwRecipientIndex$set(MemorySegment seg, long index, int x) {
        _CMSG_CTRL_DECRYPT_PARA.dwRecipientIndex$VH.set(seg.asSlice(index*sizeof()), x);
    }
