...
public class tagCBT_CREATEWNDW {
    ...
    public static MemorySegment lpcs$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagCBT_CREATEWNDW.lpcs$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpcs$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagCBT_CREATEWNDW.lpcs$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment hwndInsertAfter$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagCBT_CREATEWNDW.hwndInsertAfter$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment hwndInsertAfter$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagCBT_CREATEWNDW.hwndInsertAfter$VH.get(seg.asSlice(index*sizeof()));
    }
