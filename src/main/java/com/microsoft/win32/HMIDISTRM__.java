...
public class HMIDISTRM__ {
    ...
    public static MemoryLayout $LAYOUT() {
        return HMIDISTRM__.$struct$LAYOUT;
    }
    ...
    public static int unused$get(MemorySegment seg) {
        return (int)HMIDISTRM__.unused$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void unused$set(MemorySegment seg, int x) {
        HMIDISTRM__.unused$VH.set(seg, x);
    }
    public static int unused$get(MemorySegment seg, long index) {
        return (int)HMIDISTRM__.unused$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void unused$set(MemorySegment seg, long index, int x) {
        HMIDISTRM__.unused$VH.set(seg.asSlice(index*sizeof()), x);
    }
