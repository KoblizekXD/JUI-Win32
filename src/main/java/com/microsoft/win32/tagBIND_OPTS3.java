...
public class tagBIND_OPTS3 {
    ...
    public static MemorySegment pServerInfo$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagBIND_OPTS3.pServerInfo$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pServerInfo$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagBIND_OPTS3.pServerInfo$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment hwnd$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagBIND_OPTS3.hwnd$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment hwnd$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagBIND_OPTS3.hwnd$VH.get(seg.asSlice(index*sizeof()));
    }
