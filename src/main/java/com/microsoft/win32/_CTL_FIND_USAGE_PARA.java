...
public class _CTL_FIND_USAGE_PARA {
    ...
    public static MemorySegment pSigner$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CTL_FIND_USAGE_PARA.pSigner$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pSigner$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CTL_FIND_USAGE_PARA.pSigner$VH.get(seg.asSlice(index*sizeof()));
    }
