...
public class _CERT_OTHER_NAME {
    ...
    public static MemorySegment pszObjId$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CERT_OTHER_NAME.pszObjId$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pszObjId$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CERT_OTHER_NAME.pszObjId$VH.get(seg.asSlice(index*sizeof()));
    }
