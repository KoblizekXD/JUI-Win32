...
public class _PRINTPROCESSOR_INFO_1A {
    ...
    public static MemorySegment pName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_PRINTPROCESSOR_INFO_1A.pName$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_PRINTPROCESSOR_INFO_1A.pName$VH.get(seg.asSlice(index*sizeof()));
    }
