...
public class tagRPC_EXTENDED_ERROR_INFO {
    ...
    public static MemorySegment ComputerName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagRPC_EXTENDED_ERROR_INFO.ComputerName$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment ComputerName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagRPC_EXTENDED_ERROR_INFO.ComputerName$VH.get(seg.asSlice(index*sizeof()));
    }
