...
public class _CMSG_CTRL_KEY_TRANS_DECRYPT_PARA {
    ...
    public static MemorySegment pKeyTrans$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CMSG_CTRL_KEY_TRANS_DECRYPT_PARA.pKeyTrans$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pKeyTrans$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CMSG_CTRL_KEY_TRANS_DECRYPT_PARA.pKeyTrans$VH.get(seg.asSlice(index*sizeof()));
    }
