...
public class _RPC_VERSION {
    ...
    public static MemoryLayout $LAYOUT() {
        return _RPC_VERSION.$struct$LAYOUT;
    }
    ...
    public static VarHandle MajorVersion$VH() {
        return _RPC_VERSION.MajorVersion$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static short MajorVersion$get(MemorySegment seg) {
        return (short)_RPC_VERSION.MajorVersion$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void MajorVersion$set(MemorySegment seg, short x) {
        _RPC_VERSION.MajorVersion$VH.set(seg, x);
    }
    public static short MajorVersion$get(MemorySegment seg, long index) {
        return (short)_RPC_VERSION.MajorVersion$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void MajorVersion$set(MemorySegment seg, long index, short x) {
        _RPC_VERSION.MajorVersion$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle MinorVersion$VH() {
        return _RPC_VERSION.MinorVersion$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static short MinorVersion$get(MemorySegment seg) {
        return (short)_RPC_VERSION.MinorVersion$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void MinorVersion$set(MemorySegment seg, short x) {
        _RPC_VERSION.MinorVersion$VH.set(seg, x);
    }
    public static short MinorVersion$get(MemorySegment seg, long index) {
        return (short)_RPC_VERSION.MinorVersion$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void MinorVersion$set(MemorySegment seg, long index, short x) {
        _RPC_VERSION.MinorVersion$VH.set(seg.asSlice(index*sizeof()), x);
    }
