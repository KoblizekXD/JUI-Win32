...
public class MOVE_FILE_RECORD_DATA {
    ...
    public static MemorySegment FileHandle$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)MOVE_FILE_RECORD_DATA.FileHandle$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment FileHandle$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)MOVE_FILE_RECORD_DATA.FileHandle$VH.get(seg.asSlice(index*sizeof()));
    }
