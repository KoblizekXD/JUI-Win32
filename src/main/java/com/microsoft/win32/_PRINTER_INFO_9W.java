...
public class _PRINTER_INFO_9W {
    ...
    public static MemoryLayout $LAYOUT() {
        return _PRINTER_INFO_9W.$struct$LAYOUT;
    }
    ...
    public static VarHandle pDevMode$VH() {
        return _PRINTER_INFO_9W.pDevMode$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pDevMode$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_PRINTER_INFO_9W.pDevMode$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pDevMode$set(MemorySegment seg, MemorySegment x) {
        _PRINTER_INFO_9W.pDevMode$VH.set(seg, x);
    }
    public static MemorySegment pDevMode$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_PRINTER_INFO_9W.pDevMode$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pDevMode$set(MemorySegment seg, long index, MemorySegment x) {
        _PRINTER_INFO_9W.pDevMode$VH.set(seg.asSlice(index*sizeof()), x);
    }
