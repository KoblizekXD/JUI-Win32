...
public class HWINEVENTHOOK__ {
    ...
    public static MemoryLayout $LAYOUT() {
        return HWINEVENTHOOK__.$struct$LAYOUT;
    }
    ...
    public static VarHandle unused$VH() {
        return HWINEVENTHOOK__.unused$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int unused$get(MemorySegment seg) {
        return (int)HWINEVENTHOOK__.unused$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void unused$set(MemorySegment seg, int x) {
        HWINEVENTHOOK__.unused$VH.set(seg, x);
    }
    public static int unused$get(MemorySegment seg, long index) {
        return (int)HWINEVENTHOOK__.unused$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void unused$set(MemorySegment seg, long index, int x) {
        HWINEVENTHOOK__.unused$VH.set(seg.asSlice(index*sizeof()), x);
    }
