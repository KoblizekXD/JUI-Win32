...
public class tagPAINTSTRUCT {
    ...
    public static MemorySegment hdc$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagPAINTSTRUCT.hdc$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment hdc$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagPAINTSTRUCT.hdc$VH.get(seg.asSlice(index*sizeof()));
    }
