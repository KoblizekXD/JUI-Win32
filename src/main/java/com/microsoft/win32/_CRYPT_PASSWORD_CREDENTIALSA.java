...
public class _CRYPT_PASSWORD_CREDENTIALSA {
    ...
    public static MemorySegment pszUsername$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CRYPT_PASSWORD_CREDENTIALSA.pszUsername$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pszUsername$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CRYPT_PASSWORD_CREDENTIALSA.pszUsername$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment pszPassword$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CRYPT_PASSWORD_CREDENTIALSA.pszPassword$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pszPassword$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CRYPT_PASSWORD_CREDENTIALSA.pszPassword$VH.get(seg.asSlice(index*sizeof()));
    }
