...
public class _CRYPT_ECC_PRIVATE_KEY_INFO {
    ...
    public static MemorySegment szCurveOid$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_CRYPT_ECC_PRIVATE_KEY_INFO.szCurveOid$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment szCurveOid$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_CRYPT_ECC_PRIVATE_KEY_INFO.szCurveOid$VH.get(seg.asSlice(index*sizeof()));
    }
