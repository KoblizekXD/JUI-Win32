...
public class IWindowForBindingUI {
    ...
    public static MemoryLayout $LAYOUT() {
        return IWindowForBindingUI.$struct$LAYOUT;
    }
    ...
    public static VarHandle lpVtbl$VH() {
        return IWindowForBindingUI.lpVtbl$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)IWindowForBindingUI.lpVtbl$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpVtbl$set(MemorySegment seg, MemorySegment x) {
        IWindowForBindingUI.lpVtbl$VH.set(seg, x);
    }
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)IWindowForBindingUI.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpVtbl$set(MemorySegment seg, long index, MemorySegment x) {
        IWindowForBindingUI.lpVtbl$VH.set(seg.asSlice(index*sizeof()), x);
    }
