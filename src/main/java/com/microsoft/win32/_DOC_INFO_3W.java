...
public class _DOC_INFO_3W {
    ...
    public static MemorySegment pDocName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_DOC_INFO_3W.pDocName$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pDocName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_DOC_INFO_3W.pDocName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment pOutputFile$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_DOC_INFO_3W.pOutputFile$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pOutputFile$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_DOC_INFO_3W.pOutputFile$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment pDatatype$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_DOC_INFO_3W.pDatatype$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pDatatype$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_DOC_INFO_3W.pDatatype$VH.get(seg.asSlice(index*sizeof()));
    }
