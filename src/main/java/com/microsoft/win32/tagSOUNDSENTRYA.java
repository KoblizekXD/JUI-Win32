...
public class tagSOUNDSENTRYA {
    ...
    public static MemorySegment lpszWindowsEffectDLL$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)tagSOUNDSENTRYA.lpszWindowsEffectDLL$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpszWindowsEffectDLL$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)tagSOUNDSENTRYA.lpszWindowsEffectDLL$VH.get(seg.asSlice(index*sizeof()));
    }
