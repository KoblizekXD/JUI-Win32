...
public class ISurrogateService {
    ...
    public static MemoryLayout $LAYOUT() {
        return ISurrogateService.$struct$LAYOUT;
    }
    ...
    public static VarHandle lpVtbl$VH() {
        return ISurrogateService.lpVtbl$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)ISurrogateService.lpVtbl$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpVtbl$set(MemorySegment seg, MemorySegment x) {
        ISurrogateService.lpVtbl$VH.set(seg, x);
    }
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)ISurrogateService.lpVtbl$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void lpVtbl$set(MemorySegment seg, long index, MemorySegment x) {
        ISurrogateService.lpVtbl$VH.set(seg.asSlice(index*sizeof()), x);
    }
