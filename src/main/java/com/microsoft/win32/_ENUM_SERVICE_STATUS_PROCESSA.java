...
public class _ENUM_SERVICE_STATUS_PROCESSA {
    ...
    public static MemorySegment lpServiceName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_ENUM_SERVICE_STATUS_PROCESSA.lpServiceName$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpServiceName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_ENUM_SERVICE_STATUS_PROCESSA.lpServiceName$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment lpDisplayName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_ENUM_SERVICE_STATUS_PROCESSA.lpDisplayName$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpDisplayName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_ENUM_SERVICE_STATUS_PROCESSA.lpDisplayName$VH.get(seg.asSlice(index*sizeof()));
    }
