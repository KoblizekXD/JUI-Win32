...
public class _RPC_SECURITY_QOS_V4_W {
    ...
    public static MemorySegment Sid$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_RPC_SECURITY_QOS_V4_W.Sid$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment Sid$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_RPC_SECURITY_QOS_V4_W.Sid$VH.get(seg.asSlice(index*sizeof()));
    }
