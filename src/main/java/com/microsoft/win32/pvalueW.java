...
public class pvalueW {
    ...
    public static MemorySegment pv_valuename$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)pvalueW.pv_valuename$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pv_valuename$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)pvalueW.pv_valuename$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment pv_value_context$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)pvalueW.pv_value_context$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pv_value_context$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)pvalueW.pv_value_context$VH.get(seg.asSlice(index*sizeof()));
    }
