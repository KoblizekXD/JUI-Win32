...
public class _HMAC_Info {
    ...
    public static MemorySegment pbInnerString$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_HMAC_Info.pbInnerString$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pbInnerString$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_HMAC_Info.pbInnerString$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment pbOuterString$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_HMAC_Info.pbOuterString$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pbOuterString$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_HMAC_Info.pbOuterString$VH.get(seg.asSlice(index*sizeof()));
    }
